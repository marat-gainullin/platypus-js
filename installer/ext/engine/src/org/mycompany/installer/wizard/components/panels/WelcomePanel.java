...
public class WelcomePanel extends ErrorMessagePanel {
            ...
            if (node instanceof Product) {
                final Product product = (Product) node;
                    ...
                    if (product.getStatus() == Status.INSTALLED) {
                        ...
                        chBox.setText("<html>"
                                + StringUtils.format(ResourceUtils.getString(WelcomePanel.class, "NWP.welcome.text.product.installed.template"),//NOI18N
                                        node.getDisplayName()));
                        ...
                        chBox = new NbiCheckBox();
                        chBox.setText("<html>"
                                + StringUtils.format(ResourceUtils.getString(WelcomePanel.class, "NWP.welcome.text.product.different.build.installed.template"),//NOI18N
                                        node.getDisplayName()));
                        ...
                        chBox = new NbiCheckBox();
                        chBox.setText("<html>"
                                + StringUtils.format(ResourceUtils.getString(WelcomePanel.class, "NWP.welcome.text.product.not.installed.template"),//NOI18N
                                        node.getDisplayName()));
                        chBox.setSelected(true);
    ...
    /////////////////////////////////////////////////////////////////////////////////
// Constants
public static final String DEFAULT_TITLE = ResourceUtils.getString(WelcomePanel.class,
            "WP.title");

 ...
 * @author Tomas Pavek
 */
@MIMEResolver.ExtensionRegistration(displayName = "#PROP_PaletteItemLoader_Name", extension = "palette_item", mimeType = "text/x-palette-item")
...
//            paletteItem.isContainer_explicit = null;
    ...
    private void loadFile() {
        ...
        try {
            ...
            InputSource input = new InputSource(new StringReader(getPrimaryFile().asText(PlatypusUtils.COMMON_ENCODING_NAME)));
            reader.parse(input);
            ...
            if (handler.componentClassName != null || displayName_key != null) {
                item.setComponentClassSource(handler.componentClassName);//new ClassSource(handler.componentClassName, handler.entries));
                paletteItem = item;
            }
     ...
     */
    static void createFile(FileObject folder, String classSource)
            throws IOException {
        ...
        try (OutputStream os = itemFile.getOutputStream(lock)) {
     ...
     */
    @Registration(position = 100, displayName = "#PROP_PaletteItemLoader_Name", mimeType = "text/x-palette-item")
    public static final class PaletteItemDataLoader extends UniFileLoader {
        ...
        public PaletteItemDataLoader() {
            super(PaletteItemDataObject.class.getName()); // NOI18N
    ...
    public static final class PaletteItemDataLoaderBeanInfo extends SimpleBeanInfo {
        ...
        private static String iconURL = "com/bearsoft/org/netbeans/modules/form/resources/palette_manager.png"; // NOI18N
    ...
    class ItemNode extends DataNode {
        ...
        public java.awt.Image getIcon(int type) {
            ...
            if (type == BeanInfo.ICON_COLOR_32x32
                ...
                if (icon32 == null) {
                    ...
                    if (icon32 == null) {
                        icon32 = ImageUtilities.loadImage("com/bearsoft/org/netbeans/modules/form/resources/palette/unknown32.gif"); // NOI18N
                    }
                }
                return icon32;
                ...
                if (icon16 == null) {
                    ...
                    if (icon16 == null) {
                        icon16 = ImageUtilities.loadImage("com/bearsoft/org/netbeans/modules/form/resources/palette/unknown.gif"); // NOI18N
                    }
                }
                return icon16;
            }
        ...
        private String getExplicitDisplayName() {
            ...
            if (displayName_key != null) {
                if (bundleName != null) {
                    try {
                        displayName = NbBundle.getBundle(bundleName).getString(displayName_key);
                    } catch (Exception ex) {
                    } // ignore failure
                }
                if (displayName == null) {
        ...
        private String getExplicitTooltip() {
            ...
            if (tooltip_key != null) {
                if (bundleName != null) {
                    try {
                        tooltip = NbBundle.getBundle(bundleName).getString(tooltip_key);
                    } catch (Exception ex) {
                    } // ignore failure
                }
                if (tooltip == null) {
        ...
        public void startElement(String uri, String localName, String qName,
            ...
            switch (qName) {
                case XML_ROOT:
                    ...
                    if (version == null) {
                        String message = NbBundle.getMessage(PaletteItemDataObject.class, "MSG_UnknownPaletteItemVersion"); // NOI18N
                        throw new SAXException(message);
                    } else if (!version.startsWith("1.")) { // NOI18N
                        String message = NbBundle.getMessage(PaletteItemDataObject.class, "MSG_UnsupportedPaletteItemVersion"); // NOI18N
                        throw new SAXException(message);
                    }

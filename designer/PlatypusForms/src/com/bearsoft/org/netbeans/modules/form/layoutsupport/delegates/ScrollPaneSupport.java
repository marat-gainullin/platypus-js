...
//    private static Method setViewportViewMethod;
     ...
     * empty. In case of JScrollPane it means to check for empty viewport.
     *
     ...
     * container; we just return 0 here - as the drag&drop does not have much
     * sense in JScrollPane
     */
    @Override
    ...
    public boolean paintDragFeedback(Container container,
            ...
            int newIndex,
            Graphics g) {
        if (checkEmptyContainer(container)) {   // empty JScrollPane - it makes sense to add something to it

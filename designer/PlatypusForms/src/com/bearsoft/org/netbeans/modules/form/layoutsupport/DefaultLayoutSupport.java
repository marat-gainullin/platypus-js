 ...
 * constraints are supported, as well as no drag&drop and no arranging features.
 *
 * @author Tomas Pavek
 */
class DefaultLayoutSupport extends AbstractLayoutSupport {
    ...
    /**
     * Derives changed properties from the instance in the meta layout. The
     * instance in the meta layout is the default instance from the container.
     * This can differ from the default instance of the layout class. For
     * example, VerticalLayout in SwingX library has gap property. The default
     * value of this property is 0, but the default value of gap property of
     * layout obtained from the default instance of JXTaskContainer is 14.
     *

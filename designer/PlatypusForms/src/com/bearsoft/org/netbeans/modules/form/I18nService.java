...
public interface I18nService {
    ...
    /**
     * Creates I18nValue object for given key and value. Should not be added to
     * the bundle file yet. (For that purpose 'update' method is called later.)
     */
    I18nValue create(String key, String value, DataObject srcDataObject);

    /**
     * Creates a copy of I18nValue, including data from all locales
     * corresponding to the actual key. The copied value does not refer to the
     * original properties file - i.e. can be added to another one.
     *
     ...
     * removed, newValue added. Update goes into given locale - parent files are
     * updated too if given key is not present in them. New properties file is
     * created if needed.
     */
    ...
    /**
     * Returns property editor to be used for editing internationalized property
     * of given type (e.g. String). If an existing suitable editor is passed
     * then it is returned and no new property editor is created.
     */
    ...
    /**
     * Returns all currently available locales for given bundle in two arrays of
     * strings. The first one containes locale suffixes, the second one
     ...
     * should be set to auto i18n, while standard user (J2SE) projects not. [If
     * we decide all projects should be internationalized, we can remove this
     * method.]
     */

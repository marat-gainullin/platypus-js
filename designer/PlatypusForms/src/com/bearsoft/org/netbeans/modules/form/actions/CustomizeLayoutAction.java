 ...
 * @author Ian Formanek
 */
@ActionID(id = "com.bearsoft.org.netbeans.modules.form.actions.CustomizeLayoutAction", category = "Form")
@ActionRegistration(displayName = "#ACT_CustomizeLayout", lazy=true)
public class CustomizeLayoutAction extends CookieAction {
    ...
    public String getName() {
        if (name == null) {
            name = NbBundle.getMessage(CustomizeLayoutAction.class, "ACT_CustomizeLayout"); // NOI18N
        }
        return name;
    }
    ...
    protected void performAction(Node[] activatedNodes) {
        ...
        if (radCookie != null) {
            ...
            if (radComp instanceof RADVisualContainer<?>) {
                Node layoutNode = ((RADVisualContainer<?>) radComp)

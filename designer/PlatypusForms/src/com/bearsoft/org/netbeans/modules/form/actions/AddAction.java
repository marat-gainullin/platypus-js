...
/**
 * Action allowing to choose a component from palette content and add it to the
 * selected containers in current form. Presented only in contextual menus
...
public class AddAction extends CallableSystemAction {
    ...
    public String getName() {
        if (name == null) {
            name = NbBundle.getMessage(AddAction.class, "ACT_Add"); // NOI18N
        }
        return name;
    }
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx(AddAction.class.getName());
    }

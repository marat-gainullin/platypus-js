...
/**
 * A custom PopupMenuUI which uses our special hacked popup factory. We use this
 * rather than replacing the global popup factory so that it won't affect
 * NetBeans itself.
 *
...
class VisualDesignerPopupMenuUI extends PopupMenuUI {
    ...
    public VisualDesignerPopupMenuUI(MenuEditLayer aLayer, PopupMenuUI aUi) {
        layer = aLayer;
        ui = aUi;
    }

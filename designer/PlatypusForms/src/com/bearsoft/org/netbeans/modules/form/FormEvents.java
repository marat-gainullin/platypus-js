 ...
 * form). Also maps handled events to methods of a "common event dispatching
 * listener" (CEDL), which may be generated by the code generator (in certain
 * modes).
 *
 * @author Tomas Pavek
 */
public class FormEvents {
    ...
    //private Map<String,ListenerInfo> usedListeners = new HashMap<>();
    ...
    public void attachEvent(Event event, String handlerName, String handlerText, String annotationText) {
        ...
        if (handlerName == null && event.hasEventHandlers()) { // nothing to do
            handlerName = event.getEventHandlerList().get(0);
            event = null;
    ...
    public String findFreeHandlerName(Event event, RADComponent<?> radComp) {
        String componentName = radComp == formModel.getTopRADComponent()
                ? "form" : radComp.getName(); // NOI18N

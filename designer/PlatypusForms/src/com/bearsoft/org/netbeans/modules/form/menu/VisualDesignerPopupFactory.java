...
class VisualDesignerPopupFactory extends PopupFactory {
    ...
    public VisualDesignerPopupFactory(MenuEditLayer aCanvas) {
    ...
    public Popup getPopup(Component owner, Component contents, int x, int y) throws IllegalArgumentException {
        ...
        if (cont == null) {
            ...
            RADVisualContainer<?> menuRAD = (RADVisualContainer<?>) canvas.formDesigner.getRadComponent(menu);
            for (RADComponent<?> c : menuRAD.getSubBeans()) {
                Component comp = canvas.formDesigner.getComponent(c);
                cont.add(comp);
            }
    ...
    private static class VisualDesignerJPanelContainer extends JPanel {
        ...
        private JMenu menu;
        private VisualDesignerPopupFactory factory;

        VisualDesignerJPanelContainer(JMenu aMenu, VisualDesignerPopupFactory aFactory) {
            menu = aMenu;
            factory = aFactory;
        }
        ...
        public void setVisible(boolean visible) {
            ...
            if (visible) {
                ...
                factory.hideOtherMenus(menu);
                // make sure this menu popup is at the right place
                factory.setLocationFromMenu(menu, this);
                // repack?
            }

...
public class FormLAF {
    ...
    /**
     * Determines whether the FormLAF has been initialized (e.g.
     * DelegatingDefaults has been installed).
     */
     ...
     */
    private static Map<Object, Object> netbeansDefaults = new HashMap<>();
    /**
     * User UIDefaults of components
     */
    private static Map<Object, Object> userDefaults = new HashMap<>();
    /**
     * Maps LAF class to its theme.
     */
    private static Map<Class<?>, MetalTheme> lafToTheme = new HashMap<>();
    /**
    ...
    /**
     * <code>FormLAF</code> has static methods only => no need for public
     * constructor.
     */
    private FormLAF() {
    }
    ...
    public static PreviewInfo initPreviewLaf(Class<?> lafClass, ClassLoader formClassLoader) {
        try {
            ...
            if (classLoader != null) {
                previewDefaults.put("ClassLoader", classLoader); // NOI18N
            }
    ...
    private static void initialize() throws Exception {
        ...
        // Resolve lazy values
        Set<Object> keySet = new HashSet<>(defaults.keySet());
    ...
    private static void copyMultiUIDefaults(UIDefaults what, Map<Object, Object> where) {
        ...
        try {
            ...
            if (i instanceof Iterator<?>) {
                Iterator<Object> iter = (Iterator<Object>) i;
                while (iter.hasNext()) {
     ...
     * LayoutStyle is created according to UIManager.getLookAndFeel() which is
     * not affected by our LAF switch => we have to create the new LayoutStyle
     * manually.
     */
     ...
     */
    private static Map<ClassLoader, Map<Object, Object>> classLoaderToDefaults = new WeakHashMap<>();
    /**
    ...
    static void setUseDesignerDefaults(FormModel formModel) {
        ...
        if (formModel == null) {
            ...
            classLoader = Lookup.getDefault().lookup(ClassLoader.class);//ClassPathUtils.getProjectClassLoader(formFile);
            classLoaderDefaults = classLoaderToDefaults.get(classLoader);
            if (classLoaderDefaults == null) {
                classLoaderDefaults = new HashMap<>();
    ...
    public static void setUsePreviewDefaults(ClassLoader classLoader, PreviewInfo info) {
        ...
        if (preview) {
            ...
            Map<Object, Object> added = new HashMap<>(classLoaderDefaults);
    ...
    private static Object changeLAFStatesLAF(Object laf) {
        Object value = null;
        try {
            java.lang.reflect.Method method = UIManager.class.getDeclaredMethod("getLAFState", new Class<?>[]{}); // NOI18N
            method.setAccessible(true);
            Object lafState = method.invoke(null, new Object[0]);
    ...
    static class DelegatingDefaults extends UIDefaults {
        ...
        /**
         * Maps class loader (project class loader of the form) to set of LAF
         * defaults added when this class loader was in use.
         */
        private Map<ClassLoader, UIDefaults> classLoaderToLAFDefaults = new WeakHashMap<>();
        /**
        ...
        public Set<Object> keySet() {
            Set<Object> set;
            if (delegating) {
                set = new HashSet<>(classLoaderLAFDefaults.keySet());
        ...
        public Set<Map.Entry<Object, Object>> entrySet() {
            ...
            if (delegating) {
                set = new HashSet<>(classLoaderLAFDefaults.entrySet());

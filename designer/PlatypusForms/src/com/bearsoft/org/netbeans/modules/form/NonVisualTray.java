...
public class NonVisualTray extends JPanel implements ExplorerManager.Provider {
    ...
    /**
     * Creates new
     * <code>NonVisualTray</code>.
     *
     * @param aFormModel the corresponding form model.
     */
    public NonVisualTray(FormModel aFormModel) {
        super();
        formModel = aFormModel;
        manager = new ExplorerManager();
        Node othersNode = FormEditor.getFormEditor(aFormModel).getOthersContainerNode();
    ...
    /**
     * Listener that synchronizes the selected nodes of the form designer and
     * the non-visual tray.
     */
    private class Listener implements PropertyChangeListener {
        ...
        /**
         * Finds a filter node (in the non-visual tray) that corresponds to the
         * passed node (RADComponentNode).
         */
    ...
    /**
     * Class that manages children of the
     * <code>NonVisualNode</code>.
     */
    private class NonVisualChildren extends FilterNode.Children {

        /**
         * Creates new
         * <code>NonVisualChildren</code>.
         *
    ...
    private static class NonVisualNode extends FilterNode {
        ...
        public Action[] getActions(boolean context) {
            java.util.List<Class<?>> forbiddenActions = Arrays.asList(new Class<?>[]{
                        MoveUpAction.class,
                        MoveDownAction.class
                    });
            Action[] actions = getOriginal().getActions(context);
            java.util.List<Action> actionList = new ArrayList<>(Arrays.asList(actions));

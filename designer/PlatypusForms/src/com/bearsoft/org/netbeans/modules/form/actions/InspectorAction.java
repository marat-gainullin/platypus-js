 ...
 */
@ActionID(id = "com.bearsoft.org.netbeans.modules.form.actions.InspectorAction", category = "Window")
@ActionRegistration(lazy = false, displayName = "#CTL_InspectorAction")
@ActionReference(path = "Menu/Window/Navigator", name = "InspectorAction", position = 200)
public class InspectorAction extends AbstractAction {
    ...
    public InspectorAction() {
        ...
        putValue(SMALL_ICON, ImageUtilities.loadImageIcon("com/bearsoft/org/netbeans/modules/form/resources/inspector.png", false)); // NOI18N
    }

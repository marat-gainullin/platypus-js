...
import com.bearsoft.org.netbeans.modules.form.InPlaceEditLayer;
...
public class KeyboardMenuNavigator extends KeyAdapter {
    ...
    private void selectNextMenuItem(int offset) {
        ...
        RADVisualComponent<?> selectedRADComponent = menuEditLayer.getSingleSelectedComponent();
    ...
    private void goUpOneLevel() {
        ...
        currentMenuRAD = currentMenuRAD.getParentComponent();
    }
    ...
    private boolean isFirstItem(RADVisualComponent<?> comp, RADVisualContainer<?> cont) {
    ...
    private boolean isLastItem(RADVisualComponent<?> comp, RADVisualContainer<?> cont) {
        int index = cont.getIndexOf(comp);
    ...
    private RADVisualContainer<?> getTopLevelMenu(RADVisualContainer<?> currentMenuRAD) {
        ...
        return getTopLevelMenu(currentMenuRAD.getParentComponent());
    }

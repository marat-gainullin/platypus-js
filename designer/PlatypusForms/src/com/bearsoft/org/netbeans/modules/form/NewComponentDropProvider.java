...
/**
 * Provider of
 * <code>NewComponentDrop</code>s. The provider should be registered in lookup
 * (ideally via
 * <code>META-INF/service</code> directory).
 *
 * @author Jan Stola
 */
public interface NewComponentDropProvider {
    ...
    /**
     * Processes given
     * <code>transferable</code> and returns the corresponding
     ...
     * <code>transferable</code> or <code>null</code> if this provider don't
     * understand to or don't want to process this data transfer.
     */

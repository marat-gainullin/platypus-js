 ...
 * @author Tomas Pavek
 */
public interface LayoutConstraints<T> {

    /**
     * Gets the properties of these component layout constraints to be presented
     * in Component Inspector for the component.
     *
     ...
     * object is used as the constraints parameter when adding a component to
     * container.
     *
     * @return the real constraints object
     */
    T getConstraintsObject();

    /**
     * Cloning method - creates a copy of the constraints. It should clone the
     * reference object inside.
     *
     * @return cloned LayoutConstraints
     */
    LayoutConstraints<T> cloneConstraints();
}

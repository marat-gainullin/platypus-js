...
public class LayoutSupportRegistry {
    ...
    private LayoutSupportRegistry(FormModel formModel) {
        formModelRef = new WeakReference<>(formModel);
    }
...
//            }
    ...
    public LayoutSupportDelegate createSupportForLayout(Class<?> layoutClass)
        ...
        if (delegateClassName == null ? DEFAULT_SUPPORT == null : delegateClassName.equals(DEFAULT_SUPPORT)) {
    ...
    // -----------
    // private methods
    private String findSuperClass(Map<String, String> map, Class<?> subClass) {
    ...
    private static String scanPalette(String wantedClassName) {
        ...
        for (int i = 0; i < paletteCategories.length; i++) {
            ...
            for (int j = 0; j < paletteItems.length; j++) {
                ...
                PaletteItem item = itemDO.getLookup().lookup(PaletteItem.class);
    ...
    private Class<?> loadClass(String className) {
        try {
            return FormUtils.loadSystemClass(className);//, formModelRef.get());
    ...
    private static Map<String, String> getContainersMap() {
        if (containerToLayoutDelegate == null) {
            ...
            containerToLayoutDelegate.put(
                    ...
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.JScrollPaneSupport"); // NOI18N
            containerToLayoutDelegate.put(
                    "java.awt.ScrollPane", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.ScrollPaneSupport"); // NOI18N
            containerToLayoutDelegate.put(
                    "javax.swing.JSplitPane", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.JSplitPaneSupport"); // NOI18N
            containerToLayoutDelegate.put(
                    "javax.swing.JTabbedPane", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.JTabbedPaneSupport"); // NOI18N
            containerToLayoutDelegate.put(
                    "javax.swing.JLayeredPane", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.JLayeredPaneSupport"); // NOI18N
            containerToLayoutDelegate.put(
                    "javax.swing.JToolBar", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.JToolBarSupport"); // NOI18N
            containerToLayoutDelegate.put(
                    "javax.swing.JMenuBar", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.MenuFakeSupport"); // NOI18N
            containerToLayoutDelegate.put(
    ...
    private static Map<String, String> getLayoutsMap() {
        if (layoutToLayoutDelegate == null) {
            ...
            layoutToLayoutDelegate.put(
                    ...
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.BorderLayoutSupport"); // NOI18N
            layoutToLayoutDelegate.put(
            ...
            layoutToLayoutDelegate.put(
                    ...
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.GridBagLayoutSupport"); // NOI18N
            layoutToLayoutDelegate.put(
                    "java.awt.GridLayout", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.GridLayoutSupport"); // NOI18N
            layoutToLayoutDelegate.put(
                    "java.awt.CardLayout", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.CardLayoutSupport"); // NOI18N
            layoutToLayoutDelegate.put(
                    "org.netbeans.lib.awtextra.AbsoluteLayout", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.AbsoluteLayoutSupport"); // NOI18N
            layoutToLayoutDelegate.put(
                    "com.eas.controls.layouts.margin.MarginLayout", // NOI18N
                    "com.bearsoft.org.netbeans.modules.form.layoutsupport.delegates.MarginLayoutSupport"); // NOI18N

...
/**
 * Action that invokes reloading of the currently active form. Presented only in
...
public class ReloadAction extends CallableSystemAction {
    ...
    public String getName() {
        if (name == null) {
            name = NbBundle.getMessage(ReloadAction.class, "ACT_ReloadForm");
        } // NOI18N
        return name;
    }
    ...
    public void performAction() {
        ...
        PlatypusFormSupport fes = PlatypusFormSupport.getFormEditor(activeTC);
        if (fes != null) {
            fes.reloadForm();
        }
    }

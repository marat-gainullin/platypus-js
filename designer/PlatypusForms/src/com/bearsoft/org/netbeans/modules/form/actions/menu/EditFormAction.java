 ...
 * container is a sub-container and also the current selected node. This action
 * is not presented visually anywhere, it is used as one of the component
 * default actions ensuring that when a designed container is double clicked,
 * the whole form is brought back to design.
 *
 * @author Tomas Pavek
 */

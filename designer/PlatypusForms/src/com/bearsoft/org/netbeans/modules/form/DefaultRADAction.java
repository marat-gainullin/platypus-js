...
public class DefaultRADAction extends CookieAction {
    ...
    /**
     * Test for enablement based on the cookies of selected nodes. Generally
     * subclasses should not override this except for strange purposes, and then
     * only calling the super method and adding a check. Just use
     * {@link #cookieClasses} and {@link #mode} to specify the enablement logic.
     *

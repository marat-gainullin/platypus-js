...
public interface NewComponentDrop {
    ...
    /**
     * Callback method that notifies about the added component. You should set
     * properties of the added component or add other beans to the model in this
     * method.
     *
     * @param componentId ID of the newly added component.
     * @param droppedOverId ID of a component the new component has been dropped
     * over; used only if the dropped component is non-visual, it

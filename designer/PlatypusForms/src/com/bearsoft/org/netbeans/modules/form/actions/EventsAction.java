...
public class EventsAction extends CookieAction {
    ...
    public String getName() {
        return NbBundle.getMessage(EventsAction.class, "ACT_Events"); // NOI18N
    }
    ...
    public JMenuItem getPopupPresenter() {
        JMenu popupMenu = new JMenu(
                NbBundle.getMessage(EventsAction.class, "ACT_Events")); // NOI18N
    ...
    private void createEventSubmenu(JMenu menu) {
        ...
        boolean readOnly = radComp.isReadOnly();
        Event[] events = readOnly
                ? radComp.getKnownEvents() : radComp.getAllEvents();
        ...
        for (int i = 0; i < events.length; i++) {
            ...
            if (handlers.length == 0) {
                ...
                jmi = new JMenu(MessageFormat.format(
    ...
    private static class EventMenuItemListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            EventProperty prop = event.getComponent().<EventProperty>getProperty(event.getId());
            if (prop != null) {

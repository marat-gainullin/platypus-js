...
/**
 * Action that focuses selected container to be edited in
...
public class EditContainerAction extends NodeAction {
    ...
    public String getName() {
        if (name == null) {
            name = NbBundle.getMessage(EditContainerAction.class, "ACT_EditContainer");
        } // NOI18N
        return name;
    }
    ...
    public static boolean isEditableComponent(RADComponent<?> radComp) {

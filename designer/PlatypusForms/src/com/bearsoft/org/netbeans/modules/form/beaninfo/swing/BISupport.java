...
abstract class BISupport extends SimpleBeanInfo {
    ...
    public Image getIcon(int type) {
        if (type == ICON_COLOR_32x32 || type == ICON_MONO_32x32) {
            return ImageUtilities.loadImage("com/bearsoft/org/netbeans/modules/form/beaninfo/swing/" + icon + "32.gif"); // NOI18N
        } else {
            return ImageUtilities.loadImage("com/bearsoft/org/netbeans/modules/form/beaninfo/swing/" + icon + ".gif"); // NOI18N
        }
    }

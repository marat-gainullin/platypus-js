...
/**
 * Hacked MenuView.Menu to use ScrollablePopupMenu instead of JPopupMenu as its
 * popup, and to filter invalid palette item nodes.
 */
public class PaletteMenuView extends JMenu {

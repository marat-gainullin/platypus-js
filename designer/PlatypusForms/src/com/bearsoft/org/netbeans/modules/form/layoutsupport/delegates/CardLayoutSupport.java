...
public class CardLayoutSupport extends AbstractLayoutSupport {
    ...
    public void selectComponent(int index) {
        ...
        if (constraints instanceof CardLayoutConstraints) {
            currentCard = (CardLayoutConstraints) constraints;
        }
    }
    ...
    public void arrangeContainer(Container container,
        ...
        if (lm instanceof CardLayout && currentCard != null) {
            ...
            ((CardLayout) lm).show(containerDelegate,
                    currentCard.getConstraintsObject());
        }
    }
     ...
     * { if (!(constr instanceof CardConstraints)) return null; // should not
     * happen
     *
    ...
    protected LayoutConstraints<?> createDefaultConstraints() {
        return new CardLayoutConstraints("card" + (getComponentCount() + 1)); // NOI18N
    }
     ...
     */
    public static class CardLayoutConstraints implements LayoutConstraints<String> {
        ...
        @Override
        public CardLayoutConstraints cloneConstraints() {
            return new CardLayoutConstraints(card);
        }
    }
}

...
public abstract class CodeGenerator {
     ...
     */
    public FormProperty<?>[] getSyntheticProperties(RADComponent<?> component) {
...
//                                                 String bodyText);
     ...
     * @param handlerName The name of the event handler
     * @param paramTypes the list of event handler parameter types
     * @param bodyText the new body text of the event handler or null for
     * default (empty) one
...
//    public abstract void gotoEventHandler(String handlerName);
    /**
     * Returns whether the specified event handler is empty (with no user code).
     * Empty handlers can be deleted without user confirmation.
     *

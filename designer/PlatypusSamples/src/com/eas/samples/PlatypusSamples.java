...
public class PlatypusSamples {
    ...
    public static final String WIZARD_ERROR_MSG = WizardDescriptor.PROP_ERROR_MESSAGE; //NOI18N
    public static final String SELECTED_INDEX = WizardDescriptor.PROP_CONTENT_SELECTED_INDEX; //NOI18N

...
public class PlatypusSamplesPanelVisual extends JPanel implements DocumentListener {
    ...
    public PlatypusSamplesPanelVisual(PlatypusSamplesWizardPanel aPanel, boolean aWithDB, boolean specifyPrjName) {
        initComponents();
        panel = aPanel;
        withDB = aWithDB;
    ...
    private void initComponents() {
        ...
        Mnemonics.setLocalizedText(projectNameLabel, bundle.getString("LBL_ProjectName")); // NOI18N

        projectLocationLabel.setLabelFor(projectLocationTextField);
        Mnemonics.setLocalizedText(projectLocationLabel, bundle.getString("LBL_ProjectLocation")); // NOI18N

        Mnemonics.setLocalizedText(browseButton, bundle.getString("LBL_Browse")); // NOI18N
        ...
        Mnemonics.setLocalizedText(createdFolderLabel, bundle.getString("LBL_ProjectFolder")); // NOI18N

        createdFolderTextField.setEditable(false);
        createdFolderTextField.setEnabled(false);

        lblDBName.setLabelFor(txtDBName);
        Mnemonics.setLocalizedText(lblDBName, NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "LBL_DBName")); // NOI18N

        lblDBLocation.setLabelFor(txtDBLocation);
        Mnemonics.setLocalizedText(lblDBLocation, NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "LBL_DBLocation")); // NOI18N
        ...
        infoDBLocation.setText(NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "CreateDatabasePanelVisual.infoTextArea.text")); // NOI18N
        ...
        projectLocationTextField.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "LBL_ProjectLocation_A11YDesc")); // NOI18N
        browseButton.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "LBL_Browse_A11YDesc")); // NOI18N
        txtDBName.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "LBL_DBName_A11YDesc")); // NOI18N
        txtDBLocation.getAccessibleContext().setAccessibleDescription(NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "LBL_DBLocation_A11YDesc")); // NOI18N
    ...
    boolean valid(WizardDescriptor wizardDescriptor) {
        ...
        if (!isJavaEECapableServerRegistered()){
            wizardDescriptor.putProperty(PlatypusSamples.WIZARD_ERROR_MSG,
                    NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "ERR_MissingJavaEE5AppServer"));
        ...
        if (!f.isDirectory() || projectLocation.length() == 0) {
            ...
            wizardDescriptor.putProperty(PlatypusSamples.WIZARD_ERROR_MSG, message);
            return false;
        }
        ...
        wizardDescriptor.putProperty(PlatypusSamples.WIZARD_ERROR_MSG, null);
    ...
    boolean validDBData(WizardDescriptor wizardDescriptor){
        ...
        if (DerbyDatabases.isDerbyRegistered()){
            ...
            if (illegalChar > -1){
                errorMsg = NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "ERR_DatabaseNameIllegalChar", (char)illegalChar);
            } else if (DerbyDatabases.databaseExists(dbName)){
                errorMsg = NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "ERR_DatabaseDirectoryExists", dbName);
            } else if (dbName.length() == 0){
                errorMsg = NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "ERR_DatabaseNameEmpty");
            }
        } else{
            errorMsg = NbBundle.getMessage(PlatypusSamplesPanelVisual.class, "ERR_JavaDBNotRegistered");
        }
        wizardDescriptor.putProperty(PlatypusSamples.WIZARD_ERROR_MSG, errorMsg);
    ...
    void store(WizardDescriptor d) {
        ...
        d.putProperty(PlatypusSamples.PROJ_DIR, new File(folder));
        d.putProperty(PlatypusSamples.NAME, name);
        
        if (withDB){
            String dbName = txtDBName.getText().trim();
            d.putProperty(PlatypusSamples.DB_NAME, dbName);
        }
    }

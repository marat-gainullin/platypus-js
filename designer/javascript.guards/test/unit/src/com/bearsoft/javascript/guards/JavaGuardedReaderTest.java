...
package com.bearsoft.javascript.guards;
 ...
 * @author Jan Pokorsky
 */
public class JavaGuardedReaderTest {

    private JavascriptGuardedSectionsProvider provider;

    private JavascriptGuardedReader instance;
    ...
    public void setUp() throws Exception {
        editor = new Editor();
        provider = new JavascriptGuardedSectionsProvider(editor);
        
        instance = new JavascriptGuardedReader(provider);
    }
    ...
    /**
     * Test of translateToCharBuff method, of class org.netbeans.modules.java.guards.JavascriptGuardedReader.
     */
    @Test

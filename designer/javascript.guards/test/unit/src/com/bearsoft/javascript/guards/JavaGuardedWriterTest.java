 ...
 * @author Jan Pokorsky
 */
public class JavaGuardedWriterTest {
    ...
    /**
     * Test of translate method, of class org.netbeans.modules.java.guards.JavascriptGuardedWriter.
     */
    @Test
    public void testTranslatePlain() {
        ...
        char[] writeBuff = "\nclass A {\n}\n".toCharArray();
        JavascriptGuardedWriter instance = new JavascriptGuardedWriter();
    ...
    public void testTranslateLINE() throws BadLocationException {
        ...
        JavascriptGuardedWriter instance = new JavascriptGuardedWriter();
        JavascriptGuardedSectionsProvider provider = new JavascriptGuardedSectionsProvider(new Editor());

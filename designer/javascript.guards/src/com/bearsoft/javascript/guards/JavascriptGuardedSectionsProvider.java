 ...
 * @author Jan Pokorsky
 */
public final class JavascriptGuardedSectionsProvider extends AbstractGuardedSectionsProvider {

    public JavascriptGuardedSectionsProvider(GuardedEditorSupport editor) {
        super(editor);
    }

    @Override
    public char[] writeSections(List<GuardedSection> sections, char[] buff) {
        JavascriptGuardedWriter writer = new JavascriptGuardedWriter();
    ...
    public AbstractGuardedSectionsProvider.Result readSections(char[] buff) {
        JavascriptGuardedReader reader = new JavascriptGuardedReader(this);

 ...
 * @author Jan Pokorsky
 */
final class JavascriptGuardedWriter {
    ...
    /** Creates a new instance of JavascriptGuardedWriter */
    public JavascriptGuardedWriter() {
    }
...
//        }
        spaces = 0;
        String magic = JavascriptGuardedReader.MAGIC_PREFIX + type.name() + ':';

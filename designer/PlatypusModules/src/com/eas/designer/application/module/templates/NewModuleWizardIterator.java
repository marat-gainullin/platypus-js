...
public class NewModuleWizardIterator extends NewApplicationElementWizardIterator {
    ...
    @TemplateRegistrations({
        ...
        @TemplateRegistration(
                ...
                position = 300,
                content = {"PlatypusAMDModuleTemplate.js", "PlatypusModuleTemplate.model"},
                displayName = "#Templates/Other/PlatypusAMDModuleTemplate",
                description = "Module.html",
                scriptEngine = "freemarker"),
        @TemplateRegistration(
                folder = "Platypus/AMD modules/Specific",
                position = 300,
                content = {"PlatypusAMDModuleDatasourceTemplate.js", "PlatypusModuleDatasourceTemplate.model"},
        ...
        @TemplateRegistration(
                folder = "Platypus/AMD modules/Specific",
                position = 300,
                content = {"PlatypusAMDModuleValidatorTemplate.js", "PlatypusModuleValidatorTemplate.model"},
        ...
        @TemplateRegistration(
                folder = "Platypus/AMD modules/Specific",
                position = 300,
                content = {"PlatypusAMDModuleResidentTemplate.js", "PlatypusModuleResidentTemplate.model"},
        ...
        @TemplateRegistration(
                folder = "Platypus/AMD modules/Specific",
                position = 300,
                content = {"PlatypusAMDModuleStatelessTemplate.js", "PlatypusModuleStatelessTemplate.model"},
        ...
        @TemplateRegistration(
                folder = "Platypus/AMD modules/Specific",
                position = 300,
                content = {"PlatypusAMDModuleStatefullTemplate.js", "PlatypusModuleStatefullTemplate.model"},

...
public class PlatypusWebModuleManager {
     ...
     */
    protected void configureWebApplication(J2eeModuleProvider aJmp) throws IOException {
    ...
    private void configureDeploymentDescriptor() throws IOException {
        FileObject webXml = webInfDir.getFileObject(WEB_XML_FILE_NAME);
        webXml.delete();
        webXml = createWebXml(webInfDir);

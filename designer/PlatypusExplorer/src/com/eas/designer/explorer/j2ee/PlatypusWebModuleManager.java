...
public class PlatypusWebModuleManager {
    ...
    protected final String START_JS_FILE_TEMPLATE = ""
            + "/*\n"//NOI18N
            + "* Do not edit this file manualy, it will be overwritted by Platypus Application Designer during application deploy process.\n"//NOI18N
            + "*/\n"//NOI18N
            + "\n"//NOI18N
            + "require([%s], function(){\n"//NOI18N
            + "\tvar f = new %s()\n"//NOI18N
    ...
    protected void setStartApplicationElement(String appElementId) throws FileNotFoundException {

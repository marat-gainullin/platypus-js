    ...
    implements LayoutManager, ScrollPaneConstants, Serializable
{
     ...
     */
    protected int vsbPolicy = HORIZONTAL_SCROLLBAR_AS_NEEDED;
    ...
    public Dimension preferredLayoutSize(Container parent)
    {
        ...
        if ((vsb != null) && (vsbPolicy != HORIZONTAL_SCROLLBAR_NEVER)) {
            if (vsbPolicy == HORIZONTAL_SCROLLBAR_ALWAYS) {
    ...
    public void layoutContainer(Container parent)
    {
        ...
        else if (vsbPolicy == HORIZONTAL_SCROLLBAR_ALWAYS) {
            vsbNeeded = true;
        }
        else if (vsbPolicy == HORIZONTAL_SCROLLBAR_NEVER) {
            vsbNeeded = false;
        }
        else {  // vsbPolicy == HORIZONTAL_SCROLLBAR_AS_NEEDED
        ...
        if ((hsb != null) && hsbNeeded) {
             ...
             */
            if ((vsb != null) && !vsbNeeded &&
                (vsbPolicy != HORIZONTAL_SCROLLBAR_NEVER)) {
        ...
        if (viewport != null) {
            ...
            if (sv != null) {
                ...
                if (vsb != null && vsbPolicy == HORIZONTAL_SCROLLBAR_AS_NEEDED) {

 ...
 * @author mg
 */
public class DropDownButton extends JDropDownButton implements HasPublished, HasComponentEvents, HasJsName, Widget {
    ...
    public JPopupMenu getDropDownMenu() {
        return super.getDropDownMenu();
    }

    @ScriptFunction
    @Override
    public void setDropDownMenu(JPopupMenu aMenu) {
        super.setDropDownMenu(aMenu);
    }

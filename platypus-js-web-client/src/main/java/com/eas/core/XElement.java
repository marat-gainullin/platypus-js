...
public class XElement extends Element {
     ...
     * passed CSS selector.
     *
     * @param aClassName the css selector
     ...
     * not contain an id).
     *
     * @param aClassName the selector/xpath query
     ...
     * not contain an id).
     *
     * @param aTagName the selector/xpath query
     * @return the matching elements
     */
    ...
    public final HandlerRegistration addEventListener(String eventType, NativeHandler handler){
        JavaScriptObject remove = _addEventListener(eventType, handler);
        return new HandlerRegistration(){
            @Override
            public void removeHandler() {
                Utils.invokeJsFunction(remove);
            }
        };
    }
    
    private final native JavaScriptObject _addEventListener(String eventType, NativeHandler handler)/*-{
        var self = this;
        function listener(evt){
            handler.@com.eas.core.XElement.NativeHandler::on(Lcom/google/gwt/dom/client/NativeEvent;)(evt);
        }

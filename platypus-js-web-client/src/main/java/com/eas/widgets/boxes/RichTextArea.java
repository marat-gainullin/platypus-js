...
public class RichTextArea extends Widget implements HasScroll, HorizontalScrollFiller, VerticalScrollFiller,
        HasValueChangeHandlers, HasEmptyText, HasJsValue,
        HasFocusHandlers, HasBlurHandlers, Focusable, HasKeyDownHandlers, HasKeyUpHandlers, HasKeyPressHandlers {

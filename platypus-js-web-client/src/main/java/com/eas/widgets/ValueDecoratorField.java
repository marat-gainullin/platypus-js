 ...
 * @author mg
 */
public abstract class ValueDecoratorField extends Widget implements HasValue, HasText,
    ...
    public Object getValue() {
        return ((HasValue) decorated).getValue();
    }

    @Override
    public void setValue(Object value) {
        ((HasValue) decorated).setValue(value);
        setClearButtonVisible(nullable && ((HasValue) decorated).getValue() != null);
        try {
            ...
            ValueChangeHandler valueChangeHandler = new ValueChangeHandler() {
                ...
                public void onValueChange(ValueChangeEvent event) {
                    if (!settingValueFromJs) {
                        ...
                        try {
                            Utils.setPathData(data, field, (JavaScriptObject)event.getNewValue());
                        } finally {

...
public class WidgetsUtils {
    ...
    public static void reapplyStyle(HasPublished aComponent) {
        if (aComponent instanceof Widget && aComponent.getPublished() != null) {
            ...
            if (published.isBackgroundSet() && published.isOpaque()) {
                WidgetsUtils.applyBackground((Widget) aComponent, published.getBackground());
            }
            if (published.isForegroundSet()) {
                WidgetsUtils.applyForeground((Widget) aComponent, published.getForeground());
            }
            if (published.isFontSet()) {
                WidgetsUtils.applyFont((Widget) aComponent, published.getFont());
            }
            if (published.isCursorSet()) {
                WidgetsUtils.applyCursor((Widget) aComponent, published.getCursor());
            }
        }
    }
    ...
    public static void walk(Widget aWidget, Callback<Widget, Widget> aObserver) {
        ...
        if (aWidget instanceof Container) {
            Container widgets = (Container) aWidget;

 ...
 * @author mg
 */
public class LocatorsTest extends DataRowsetBaseTest {

    // 1 criterion locators tests
    protected static Object[] locatorsKeys = new Object[]{true, "sample string data22", null, null, 345677.9898d, 748677.0d, "true string7"};
    ...
    protected static Object[] locatorMultiKey = new Object[]{/*21L, */false, "sample string data22", new Date(millis + 18), null, 345677.9898d, 345677.0d, "true string22"};
    protected static int mkRowsetPosition = 21;

    public void testSimpleLocator1Criteria() throws InvalidCursorPositionException, InvalidColIndexException, RowsetException {
    ...
    public void testSimpleLocator1CriteriaWrongTypes() throws InvalidCursorPositionException, InvalidColIndexException, RowsetException {
    ...
    public void testSimpleLocatorMultiCriteria() throws InvalidCursorPositionException, InvalidColIndexException, RowsetException {
    ...
    public void testCrudLocator() throws InvalidCursorPositionException, InvalidColIndexException, RowsetException {
        ...
        assertEquals(loc.getRowset().getCursorPos(), mkRowsetPosition);
        rowset.updateObject(6, 345677.9898d);
        assertEquals(loc.getRowset().getCursorPos(), mkRowsetPosition);

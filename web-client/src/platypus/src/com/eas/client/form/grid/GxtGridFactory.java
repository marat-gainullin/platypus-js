...
import com.eas.client.form.grid.columns.ModelGridDateColumn;
import com.eas.client.form.grid.columns.ModelGridObjectColumn;
import com.eas.client.form.grid.columns.ModelGridSpinColumn;
import com.eas.client.form.grid.columns.ModelGridTextColumn;
import com.eas.client.form.grid.columns.RowValueGridColumn;
import com.eas.client.form.grid.rowmarker.RowMarker;
import com.eas.client.form.grid.rows.RowChildrenFetcher;
import com.eas.client.form.grid.rows.RowsListStoreFiller;
import com.eas.client.form.grid.rows.RowsTreeStoreFiller;
import com.eas.client.form.grid.rows.RowsetDataProvider;
import com.eas.client.form.grid.wrappers.PlatypusColumnConfig;
import com.eas.client.form.grid.wrappers.PlatypusGridInlineRowEditing;
import com.eas.client.form.grid.wrappers.PlatypusGridView;
import com.eas.client.form.grid.wrappers.PlatypusTreeGridView;
import com.eas.client.form.js.JsEvents;
import com.eas.client.form.published.PublishedCell;
import com.eas.client.form.published.PublishedStyle;
import com.eas.client.form.published.widgets.MaskingTreeGrid;
import com.eas.client.form.published.widgets.PlatypusAdapterCellField;
						...
						public void render(final com.google.gwt.cell.client.Cell.Context context, Object value, SafeHtmlBuilder sb) {
							try {
								...
								PublishedCell cellToRender = calcContextPublishedCell(column.getEventsThis(),
								        column.getOnRender() != null ? column.getOnRender() : modelGrid.getGeneralCellFunction(), context, aColModelElement, toRender);
					...
					cc.setCell(new AbstractCell<String>() {
						...
						public void render(com.google.gwt.cell.client.Cell.Context context, String value, SafeHtmlBuilder sb) {
							try {
								...
								PublishedCell cellToRender = calcContextPublishedCell(column.getEventsThis(),
								        column.getOnRender() != null ? column.getOnRender() : modelGrid.getGeneralCellFunction(), context, aColModelElement, value);
								if (cellToRender != null) {
									styleToRender = cellToRender.getStyle();
									if (cellToRender.getDisplay() != null)
										toRender = cellToRender.getDisplay();
					...
					CheckBoxCell cell = new CheckBoxCell() {
						...
						public void render(com.google.gwt.cell.client.Cell.Context context, Boolean value, SafeHtmlBuilder sb) {
							try {
								...
								SafeHtmlBuilder lsb = new SafeHtmlBuilder();
								PublishedCell cellToRender = calcContextPublishedCell(column.getEventsThis(),
								        column.getOnRender() != null ? column.getOnRender() : modelGrid.getGeneralCellFunction(), context, aColModelElement, null);
								if (cellToRender != null) {
									styleToRender = cellToRender.getStyle();
								}
			...
			cc.setCell(new AbstractCell<String>() {
				...
				public void render(com.google.gwt.cell.client.Cell.Context context, String value, SafeHtmlBuilder sb) {
					try {
						...
						PublishedStyle styleToRender = null;
						SafeHtmlBuilder lsb = new SafeHtmlBuilder();
						PublishedCell cellToRender = calcContextPublishedCell(column.getEventsThis(), column.getOnRender() != null ? column.getOnRender() : modelGrid.getGeneralCellFunction(),

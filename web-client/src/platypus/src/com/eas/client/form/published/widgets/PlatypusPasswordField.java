...
public class PlatypusPasswordField extends PasswordTextBox implements HasJsFacade, HasEmptyText, HasComponentPopupMenu, HasEventsExecutor {
				...
				menuTriggerReg = super.addDomHandler(new ClickHandler() {
					...
					public void onClick(ClickEvent event) {
						if (event.getNativeButton() == NativeEvent.BUTTON_RIGHT && menu != null) {
							menu.showRelativeTo(PlatypusPasswordField.this);
						}
					}

...
public class PlatypusTextHandledField extends PlatypusTextField {

	protected PlatypusTextHandledInputCell textCell;

	public PlatypusTextHandledField(PlatypusTextHandledInputCell aCell) {
		super(aCell);
		textCell = aCell;
	...
	protected void onRedraw() {
		...
		PublishedCell calcedPublishedCell = textCell.getPublishedCell();
		if (calcedPublishedCell != null) {
			calcedPublishedCell.styleToElement(getInputEl());
		}
	}
}

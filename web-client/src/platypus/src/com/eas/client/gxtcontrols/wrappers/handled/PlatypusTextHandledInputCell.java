...
public class PlatypusTextHandledInputCell extends TextInputCell {

	protected PlatypusTextHandledField container;
	protected ModelElementRef modelElement;
	protected JavaScriptObject cellFunction;
	protected PublishedCell cellToRender;

	public PlatypusTextHandledInputCell() {
		this(null, null);
	}

	public PlatypusTextHandledInputCell(ModelElementRef aModelElement, JavaScriptObject aCellFunction) {
		super();
	...
	public void setContainer(PlatypusTextHandledField aHandledField) {

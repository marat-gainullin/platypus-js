	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		published.add = function(toAdd){
			if(toAdd && toAdd.unwrap){
				...
				aWidget.@com.eas.form.published.containers.ScrollPane::setWidget(Lcom/google/gwt/user/client/ui/Widget;)(toAdd.unwrap());
			}
		}
		Object.defineProperty(published, "view", {
			get : function(){
				var widget = aWidget.@com.eas.form.published.containers.ScrollPane::getWidget()();
		...
		Object.defineProperty(published, "horizontalScrollBarPolicy", {
			get: function(){
				return aWidget.@com.eas.form.published.containers.ScrollPane::getHorizontalScrollBarPolicy()();
			},
			set: function(aValue){
				aWidget.@com.eas.form.published.containers.ScrollPane::setHorizontalScrollBarPolicy(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalScrollBarPolicy", {
			get: function(){
				return aWidget.@com.eas.form.published.containers.ScrollPane::getVerticalScrollBarPolicy()();
			},
			set: function(aValue){
				aWidget.@com.eas.form.published.containers.ScrollPane::setVerticalScrollBarPolicy(I)(+aValue);
			}
		});
	}-*/;

...
import com.eas.form.HorizontalPosition;
import com.eas.form.VerticalPosition;
...
public class BorderPane extends BorderPanel implements HasJsFacade, HasEnabled, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers, HasHideHandlers, HasResizeHandlers, HasAddHandlers,
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		...
		Object.defineProperty(published, "hgap", {
			get : function(){
				return aWidget.@com.eas.form.published.containers.BorderPane::getHgap()();
			},
			set : function(aValue){
				aWidget.@com.eas.form.published.containers.BorderPane::setHgap(I)(aValue);
			}
		});
		Object.defineProperty(published, "vgap", {
			get : function(){
				return aWidget.@com.eas.form.published.containers.BorderPane::getVgap()();
			},
			set : function(aValue){
				aWidget.@com.eas.form.published.containers.BorderPane::setVgap(I)(aValue);
			}
		});
		Object.defineProperty(published, "leftComponent", {
			get : function() {
				var comp = aWidget.@com.eas.form.published.containers.BorderPane::getLeftComponent()();
				return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(comp);
			},
			set : function(aChild) {
				aWidget.@com.eas.form.published.containers.BorderPane::setLeftComponent(Lcom/google/gwt/user/client/ui/Widget;D)(aChild.unwrap(), toAdd.width);
			}
		});
		Object.defineProperty(published, "rightComponent", {
			get : function() {
				var comp = aWidget.@com.eas.form.published.containers.BorderPane::getRightComponent()();
				return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(comp);
			},
			set : function(aChild) {
				aWidget.@com.eas.form.published.containers.BorderPane::setRightComponent(Lcom/google/gwt/user/client/ui/Widget;D)(aChild.unwrap(), toAdd.width);
			}
		});
		Object.defineProperty(published, "topComponent", {
			get : function() {
				var comp = aWidget.@com.eas.form.published.containers.BorderPane::getTopComponent()();
				return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(comp);
			},
			set : function(aChild) {
				aWidget.@com.eas.form.published.containers.BorderPane::setTopComponent(Lcom/google/gwt/user/client/ui/Widget;D)(aChild.unwrap(), toAdd.height);
			}
		});
		Object.defineProperty(published, "bottomComponent", {
			get : function() {
				var comp = aWidget.@com.eas.form.published.containers.BorderPane::getBottomComponent()();
				return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(comp);
			},
			set : function(aChild) {
				aWidget.@com.eas.form.published.containers.BorderPane::setBottomComponent(Lcom/google/gwt/user/client/ui/Widget;D)(aChild.unwrap(), toAdd.height);
			}
		});
		Object.defineProperty(published, "centerComponent", {
			get : function() {
				var comp = aWidget.@com.eas.form.published.containers.BorderPane::getCenterComponent()();
				return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(comp);
			},
			set : function(aChild) {
			 	aWidget.@com.eas.form.published.containers.BorderPane::setCenterComponent(Lcom/google/gwt/user/client/ui/Widget;)(aChild.unwrap());
			}
		});
			...
			if(toAdd != undefined && toAdd != null && toAdd.unwrap != undefined){
				...
				switch (region) {
					case Ui.VerticalPosition.CENTER:
						aWidget.@com.eas.form.published.containers.BorderPane::setCenterComponent(Lcom/google/gwt/user/client/ui/Widget;)(toAdd.unwrap());
						break;  
					case Ui.VerticalPosition.TOP: 
						...
						aWidget.@com.eas.form.published.containers.BorderPane::setTopComponent(Lcom/google/gwt/user/client/ui/Widget;D)(toAdd.unwrap(), aSize);
						break;  
					case Ui.VerticalPosition.BOTTOM: 
						...
						aWidget.@com.eas.form.published.containers.BorderPane::setBottomComponent(Lcom/google/gwt/user/client/ui/Widget;D)(toAdd.unwrap(), aSize);
						break;  
					case Ui.HorizontalPosition.LEFT: 
						...
						aWidget.@com.eas.form.published.containers.BorderPane::setLeftComponent(Lcom/google/gwt/user/client/ui/Widget;D)(toAdd.unwrap(), aSize);
						break;  
					case Ui.HorizontalPosition.RIGHT: 
						...
						aWidget.@com.eas.form.published.containers.BorderPane::setRightComponent(Lcom/google/gwt/user/client/ui/Widget;D)(toAdd.unwrap(), aSize);
						break;  
				}
			}
		}

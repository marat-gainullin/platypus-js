...
public class PlatypusMenu extends PlatypusMenuBar {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.menu.PlatypusMenu::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.menu.PlatypusMenu::setText(Ljava/lang/String;)(aValue!=null?''+aValue:null);
			}
		});
	}-*/;
}

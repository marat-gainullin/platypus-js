...
public class ToolBar extends Toolbar implements HasJsFacade, HasEnabled, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers,
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		published.add = function(toAdd){
			if(toAdd && toAdd.unwrap){
				...
				aWidget.@com.eas.form.published.containers.ToolBar::add(Lcom/google/gwt/user/client/ui/Widget;)(toAdd.unwrap());
				aWidget.@com.eas.form.published.containers.ToolBar::ajustWidth(Lcom/google/gwt/user/client/ui/Widget;I)(toAdd.unwrap(), widgetWidth);
			}
		};		
	}-*/;

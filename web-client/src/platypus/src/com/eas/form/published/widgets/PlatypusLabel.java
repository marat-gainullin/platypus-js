...
public class PlatypusLabel extends ImageLabel implements RequiresResize, HasJsFacade, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers, HasHideHandlers, HasResizeHandlers {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		...
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setText(Ljava/lang/String;)(aValue!=null?''+aValue:null);
			}
		});
		Object.defineProperty(published, "icon", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getImageResource()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setImageResource(Lcom/google/gwt/resources/client/ImageResource;)(aValue);
			}
		});
		Object.defineProperty(published, "iconTextGap", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getIconTextGap()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setIconTextGap(I)(aValue);
			}
		});
		Object.defineProperty(published, "horizontalTextPosition", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getHorizontalTextPosition()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setHorizontalTextPosition(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalTextPosition", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getVerticalTextPosition()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setVerticalTextPosition(I)(+aValue);
			}
		});

		Object.defineProperty(published, "horizontalAlignment", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getHorizontalAlignment()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setHorizontalAlignment(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalAlignment", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusLabel::getVerticalAlignment()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusLabel::setVerticalAlignment(I)(+aValue);
			}
		});
	}-*/;
}

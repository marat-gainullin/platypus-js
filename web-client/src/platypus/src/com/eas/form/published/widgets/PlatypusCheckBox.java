...
public class PlatypusCheckBox extends CheckBox implements HasActionHandlers, HasJsFacade, HasPlatypusButtonGroup, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers, HasHideHandlers, HasResizeHandlers, RequiresResize {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusCheckBox::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusCheckBox::setText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(published, "selected", {
			get : function() {
				var value = aWidget.@com.eas.form.published.widgets.PlatypusCheckBox::getValue()();
				if (value == null)
					return null;
				else
					return aWidget.@com.eas.form.published.widgets.PlatypusCheckBox::getPlainValue()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusCheckBox::setPlainValue(Z)(aValue!=null && (false != aValue));
			}
		});

...
import com.eas.form.published.PublishedMarginConstraints;
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		published.add = function(toAdd, aConstraints) {
			if(toAdd && toAdd.unwrap) {
				...
				aWidget.@com.eas.form.published.containers.AnchorsPane::add(Lcom/google/gwt/user/client/ui/Widget;Lcom/eas/form/published/PublishedMarginConstraints;)(toAdd.unwrap(), aConstraints || null);
			}
		};
	}-*/;
}

...
public abstract class ModelDecoratorBox<T> extends DecoratorBox<T> implements HasJsFacade, HasJsValue, HasText, HasCustomEditing, HasBinding, HasOnRender, HasOnSelect, HasComponentPopupMenu,
	...
	private static native void publish(HasJsFacade aWidget, JavaScriptObject aPublished)/*-{
		Object.defineProperty(aPublished, "onSelect", {
			get : function() {
				return aWidget.@com.eas.form.published.HasOnSelect::getOnSelect()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasOnSelect::setOnSelect(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "onRender", {
			get : function() {
				return aWidget.@com.eas.form.published.HasOnRender::getOnRender()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasOnRender::setOnRender(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "editable", {
			get : function() {
				return aWidget.@com.eas.form.published.HasCustomEditing::isEditable()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasCustomEditing::setEditable(Z)(!!aValue);
			}
		});
		...
		Object.defineProperty(aPublished, "selectOnly", {
			get : function() {
				return aWidget.@com.eas.form.published.HasCustomEditing::isSelectOnly()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasCustomEditing::setSelectOnly(Z)(!!aValue);
			}
		});

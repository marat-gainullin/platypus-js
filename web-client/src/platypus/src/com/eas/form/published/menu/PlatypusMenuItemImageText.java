...
public class PlatypusMenuItemImageText extends MenuItemImageText implements HasActionHandlers, HasJsFacade, HasEventsExecutor {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject aPublished)/*-{
		Object.defineProperty(aPublished, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.menu.PlatypusMenuItemImageText::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.menu.PlatypusMenuItemImageText::setText(Ljava/lang/String;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "icon", {
			get : function() {
				return aWidget.@com.eas.form.published.menu.PlatypusMenuItemImageText::getIcon()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.menu.PlatypusMenuItemImageText::setIcon(Lcom/google/gwt/resources/client/ImageResource;)(aValue);
			}
		});			
	}-*/;
}

...
public class ModelFormattedField extends ModelDecoratorBox<Object> implements HasEmptyText, HasActionHandlers {
	...
	private native static void publish(ModelFormattedField aWidget, JavaScriptObject aPublished)/*-{
		...
		Object.defineProperty(aPublished, "emptyText", {
			get : function() {
				return aWidget.@com.eas.form.published.HasEmptyText::getEmptyText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasEmptyText::setEmptyText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(aPublished, "value", {
			get : function() {
				return B.boxAsJs(aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::getJsValue()());
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::setJsValue(Ljava/lang/Object;)(B.boxAsJava(aValue));
			}
		});
		Object.defineProperty(aPublished, "valueType", {
			get : function() {
				var typeNum = aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::getValueType()()
				var type;
			...
			set : function(aValue) {
				...
				aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::setValueType(I)(typeNum);
			}
		});
		Object.defineProperty(aPublished, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::setText(Ljava/lang/String;)(B.boxAsJava(aValue));
			}
		});
		Object.defineProperty(aPublished, "format", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::getFormat()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::setFormat(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(aPublished, "onFormat", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::getOnFormat()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::setOnFormat(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "onParse", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::getOnParse()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelFormattedField::setOnParse(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
	}-*/;

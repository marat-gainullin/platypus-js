...
import com.eas.form.published.widgets.ConstraintedSpinnerBox;
...
public class ModelSpin extends ModelDecoratorBox<Double> implements HasEmptyText, HasActionHandlers {
	...
	private native static void publish(ModelSpin aWidget, JavaScriptObject aPublished)/*-{
		...
		Object.defineProperty(aPublished, "value", {
			get : function() {
				var v = aWidget.@com.eas.form.published.widgets.model.ModelSpin::getValue()();
				if (v != null) {
			...
			set : function(aValue) {
				if (aValue != null) {
					...
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setValue(Ljava/lang/Double;Z)(d, true);
				} else {
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setValue(Ljava/lang/Double;Z)(null, true);
				}
			}
		});
		Object.defineProperty(aPublished, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelSpin::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelSpin::setText(Ljava/lang/String;)(aValue != null ? aValue + '' : '');
			}
		});
		Object.defineProperty(aPublished, "min", {
			get : function() {
				var v = aWidget.@com.eas.form.published.widgets.model.ModelSpin::getMin()();
				if (v != null) {
					return v.@java.lang.Number::doubleValue()();
				} else
					return null;
			...
			set : function(aValue) {
				if (aValue != null) {
					var v = aValue * 1;
					var d = @java.lang.Double::new(D)(v);
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setMin(Ljava/lang/Double;)(d);
				} else {
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setMin(Ljava/lang/Double;)(null);
				}
			}
		});
		Object.defineProperty(aPublished, "max", {
			get : function() {
				var v = aWidget.@com.eas.form.published.widgets.model.ModelSpin::getMax()();
				if (v != null) {
					return v.@java.lang.Number::doubleValue()();
				} else
					return null;
			...
			set : function(aValue) {
				if (aValue != null) {
					var v = aValue * 1;
					var d = @java.lang.Double::new(D)(v);
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setMax(Ljava/lang/Double;)(d);
				} else {
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setMax(Ljava/lang/Double;)(null);
				}
			}
		});
		Object.defineProperty(aPublished, "step", {
			get : function() {
				var v = aWidget.@com.eas.form.published.widgets.model.ModelSpin::getStep()();
				if (v != null) {
					return v.@java.lang.Number::doubleValue()();
				} else
					return null;
			...
			set : function(aValue) {
				if (aValue != null) {
					var v = aValue * 1;
					var d = @java.lang.Double::new(D)(v);
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setStep(Ljava/lang/Double;)(d);
				} else {
					aWidget.@com.eas.form.published.widgets.model.ModelSpin::setStep(Ljava/lang/Double;)(null);
				}
			}
		});
	}-*/;

...
public class PlatypusMenuItemRadioButton extends MenuItemRadioButton implements HasActionHandlers, HasJsFacade, HasPlatypusButtonGroup, HasEventsExecutor {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.menu.PlatypusMenuItemRadioButton::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.menu.PlatypusMenuItemRadioButton::setText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(published, "selected", {
			get : function() {
				return aWidget.@com.eas.form.published.menu.PlatypusMenuItemRadioButton::getPlainValue()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.menu.PlatypusMenuItemRadioButton::setPlainValue(Z)(aValue != null && !!aValue);
			}
		});

...
public class PlatypusProgressBar extends ProgressBar implements HasJsFacade, HasEnabled, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers, HasHideHandlers, HasResizeHandlers {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "value", {
			get : function() {
				var v = aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::getValue()();
				if (v != null) {
			...
			set : function(aValue) {
				if (aValue != null) {
					...
					aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::setValue(Ljava/lang/Double;Z)(d, true);
				} else {
					aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::setValue(Ljava/lang/Double;Z)(null, true);
				}
			}
		});
		Object.defineProperty(published, "minimum", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::getMinProgress()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::setMinProgress(D)(aValue);
			}
		});
		Object.defineProperty(published, "maximum", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::getMaxProgress()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::setMaxProgress(D)(aValue);
			}
		});
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusProgressBar::setText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
	}-*/;
}

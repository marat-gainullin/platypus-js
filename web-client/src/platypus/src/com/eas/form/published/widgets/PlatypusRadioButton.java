...
public class PlatypusRadioButton extends RadioButton implements HasActionHandlers, HasJsFacade, HasPlatypusButtonGroup, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers, HasHideHandlers, HasResizeHandlers, RequiresResize {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusRadioButton::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusRadioButton::setText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(published, "selected", {
			get : function() {
				var value = aWidget.@com.eas.form.published.widgets.PlatypusRadioButton::getValue()();
				if (value == null)
					return null;
				else
					return aWidget.@com.eas.form.published.widgets.PlatypusRadioButton::getPlainValue()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusRadioButton::setPlainValue(Z)(aValue!=null && (false != aValue));
			}
		});

...
import com.eas.form.grid.rows.JsArrayList;
...
public class ModelCombo extends ModelDecoratorBox<JavaScriptObject> implements HasEmptyText, HasActionHandlers {
	...
	private native static void publish(ModelCombo aWidget, JavaScriptObject aPublished)/*-{
        ...
        Object.defineProperty(aPublished, "value", {
	        get : function() {
	            return B.boxAsJs(aWidget.@com.eas.form.published.widgets.model.ModelCombo::getJsValue()());
	        },
	        set : function(aValue) {
	 	        if (aValue != null) {
		            aWidget.@com.eas.form.published.widgets.model.ModelCombo::setJsValue(Ljava/lang/Object;)(B.boxAsJava(aValue));
		        } else {
		            aWidget.@com.eas.form.published.widgets.model.ModelCombo::setJsValue(Ljava/lang/Object;)(null);
		        }
	        }
        });
        Object.defineProperty(aPublished, "text", {
	        get : function() {
	            return aWidget.@com.eas.form.published.widgets.model.ModelCombo::getText()();
	        }
        });
        Object.defineProperty(aPublished, "displayList", {
	        get : function() {
	            return aWidget.@com.eas.form.published.widgets.model.ModelCombo::getDisplayList()();
	        },
	        set : function(aValue) {
	            aWidget.@com.eas.form.published.widgets.model.ModelCombo::setDisplayList(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
	        }
        });
        Object.defineProperty(aPublished, "displayField", {
	        get : function() {
	            return aWidget.@com.eas.form.published.widgets.model.ModelCombo::getDisplayField()();
	        },
	        set : function(aValue) {
	            aWidget.@com.eas.form.published.widgets.model.ModelCombo::setDisplayField(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
	        }
        });
        Object.defineProperty(aPublished, "list", {
	        get : function() {
	            return aWidget.@com.eas.form.published.widgets.model.ModelCombo::isList()();
	        },
	        set : function(aValue) {
	            aWidget.@com.eas.form.published.widgets.model.ModelCombo::setList(Z)(false != aValue);
	        }
        });
    }-*/;

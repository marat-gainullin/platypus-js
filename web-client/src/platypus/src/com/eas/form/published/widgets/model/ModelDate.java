...
public class ModelDate extends ModelDecoratorBox<Date> implements HasEmptyText, HasActionHandlers {
	...
	private native static void publish(ModelDate aWidget, JavaScriptObject aPublished)/*-{
		...
		Object.defineProperty(aPublished, "value", {
			get : function() {
				return B.boxAsJs(aWidget.@com.eas.form.published.widgets.model.ModelDate::getJsValue()());
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelDate::setJsValue(Ljava/lang/Object;)(B.boxAsJava(aValue));
			}
		});
		Object.defineProperty(aPublished, "text", {
			get : function() {
				return B.boxAsJs(aWidget.@com.eas.form.published.widgets.model.ModelDate::getText()());
			}
		});
		Object.defineProperty(aPublished, "dateFormat", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelDate::getFormat()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelDate::setFormat(Ljava/lang/String;)('' + aValue);
			}
		});
		Object.defineProperty(aPublished, "datePicker", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelDate::isDateShown()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelDate::setDateShown(Z)(aValue);
			}
		});
		Object.defineProperty(aPublished, "timePicker", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelDate::isTimeShown()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelDate::setTimeShown(Z)(aValue);
			}
		});

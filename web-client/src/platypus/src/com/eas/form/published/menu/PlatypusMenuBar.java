	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		published.add = function(toAdd){
			if(toAdd && toAdd.unwrap){
				...
				aWidget.@com.eas.form.published.menu.PlatypusMenuBar::add(Lcom/google/gwt/user/client/ui/UIObject;)(toAdd.unwrap());
			}
		};
		published.remove = function(aChild) {
			if (aChild && aChild.unwrap) {
				aWidget.@com.eas.form.published.menu.PlatypusMenuBar::remove(Lcom/google/gwt/user/client/ui/UIObject;)(aChild.unwrap());
			}
		};
		published.clear = function() {
			aWidget.@com.eas.form.published.menu.PlatypusMenuBar::clearItems()();
		};
		published.child = function(aIndex) {
			var comp = aWidget.@com.eas.form.published.menu.PlatypusMenuBar::getItem(I)(aIndex);
			return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(comp);
		};
		Object.defineProperty(published, "count", {
			get : function() {
				return aWidget.@com.eas.form.published.menu.PlatypusMenuBar::getCount()();
			}
		});

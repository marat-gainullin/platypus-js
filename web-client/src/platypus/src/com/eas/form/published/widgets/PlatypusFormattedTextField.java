...
public class PlatypusFormattedTextField extends FormattedObjectBox implements HasJsFacade, HasEmptyText, HasComponentPopupMenu, HasActionHandlers, HasEventsExecutor, HasShowHandlers, HasHideHandlers,
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		...
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::setText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		...
		Object.defineProperty(published, "value", {
			get : function() {
				return B.boxAsJs(aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::getJsValue()());
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::setJsValue(Ljava/lang/Object;)(B.boxAsJava(aValue));
			}
		});
		Object.defineProperty(published, "valueType", {
			get : function() {
				var typeNum = aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::getValueType()()
				var type;
			...
			set : function(aValue) {
				...
				aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::setValueType(I)(typeNum);
			}
		});
		
		Object.defineProperty(published, "format", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::getFormat()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::setFormat(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(published, "onFormat", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::getOnFormat()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::setOnFormat(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(published, "onParse", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::getOnParse()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusFormattedTextField::setOnParse(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
	}-*/;
}

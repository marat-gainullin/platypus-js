...
//		    lb.addItem(strings.normal(), "");
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "value", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusHtmlEditor::getValue()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusHtmlEditor::setValue(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});

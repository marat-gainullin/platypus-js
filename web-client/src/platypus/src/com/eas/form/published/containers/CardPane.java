	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		...
		published.add = function(toAdd, aCardName){
			if(toAdd && toAdd.unwrap){
				...
				aWidget.@com.eas.form.published.containers.CardPane::add(Lcom/google/gwt/user/client/ui/Widget;Ljava/lang/String;)(toAdd.unwrap(), aCardName);
			}
		};
		published.child = function(aIndex_or_aCardName) {
			var widget;
			if (isNaN(aIndex_or_aCardName)) {
				widget = aWidget.@com.eas.form.published.containers.CardPane::getWidget(Ljava/lang/String;)(aIndex_or_aCardName);
			}else {
				var index = parseInt(aIndex_or_aCardName, 10);
				widget = aWidget.@com.eas.form.published.containers.CardPane::getWidget(I)(index);
			}
			return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(widget);
		};
		published.show = function(aCardName) {
			aWidget.@com.eas.form.published.containers.CardPane::show(Ljava/lang/String;)(aCardName);
		};			
	}-*/;

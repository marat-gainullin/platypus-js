...
public class ModelTextArea extends ModelDecoratorBox<String> implements HasEmptyText {
	...
	protected native static void publish(ModelTextArea aWidget, JavaScriptObject aPublished)/*-{
		...
		Object.defineProperty(aPublished, "value", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelTextArea::getValue()();
			},
			set : function(aValue) {
				if (aValue != null)
					aWidget.@com.eas.form.published.widgets.model.ModelTextArea::setValue(Ljava/lang/String;)('' + aValue);
				else
					aWidget.@com.eas.form.published.widgets.model.ModelTextArea::setValue(Ljava/lang/String;)(null);
			}
		});
		Object.defineProperty(aPublished, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelTextArea::getText()();
			},
			set : function(aValue) {
				if (aValue != null)
					aWidget.@com.eas.form.published.widgets.model.ModelTextArea::setValue(Ljava/lang/String;)('' + aValue);

...
public class PlatypusPasswordField extends PasswordTextBox implements HasJsFacade, HasEmptyText, HasComponentPopupMenu, HasActionHandlers, HasEventsExecutor, HasShowHandlers, HasHideHandlers,
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusPasswordField::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusPasswordField::setText(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(published, "value", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusPasswordField::getValue()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusPasswordField::setJsValue(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});

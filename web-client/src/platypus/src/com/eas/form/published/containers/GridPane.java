	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		published.add = function(toAdd, aRow, aCol){
			if(toAdd && toAdd.unwrap){
				...
				aWidget.@com.eas.form.published.containers.GridPane::setWidget(IILcom/google/gwt/user/client/ui/Widget;)(1 * aRow, 1 * aCol, toAdd.unwrap());
			}
		}
		published.remove = function(aChild) {
			if (aChild && aChild.unwrap) {
				aWidget.@com.eas.form.published.containers.GridPane::remove(Lcom/google/gwt/user/client/ui/Widget;)(aChild.unwrap());				
			}
		};
		published.child = function(aRow, aCol) {
			if (arguments.length > 1) {
				var widget = aWidget.@com.eas.form.published.containers.GridPane::getWidget(II)(1 * aRow, 1 * aCol);
				return !!widget ? @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(widget) : null;
			}else
				return null;
		};
		Object.defineProperty(published, "hgap", {
			get : function(){
				return aWidget.@com.eas.form.published.containers.GridPane::getHgap()();
			},
			set : function(aValue){
				aWidget.@com.eas.form.published.containers.GridPane::setHgap(I)(aValue);
			}
		});
		Object.defineProperty(published, "vgap", {
			get : function(){
				return aWidget.@com.eas.form.published.containers.GridPane::getVgap()();
			},
			set : function(aValue){
				aWidget.@com.eas.form.published.containers.GridPane::setVgap(I)(aValue);
			}
		});
		Object.defineProperty(published, "rows", {
			get : function(){
				return aWidget.@com.eas.form.published.containers.GridPane::getRowCount()();
			}
		});
		Object.defineProperty(published, "columns", {
			get : function(){
				return aWidget.@com.eas.form.published.containers.GridPane::getColumnCount()();
			}
		});

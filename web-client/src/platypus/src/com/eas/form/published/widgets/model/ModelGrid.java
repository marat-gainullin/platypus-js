package com.eas.form.published.widgets.model;
...
import com.eas.form.ControlsUtils;
import com.eas.form.EventsExecutor;
import com.eas.form.JavaScriptObjectKeyProvider;
import com.eas.form.Publisher;
import com.eas.form.grid.CursorPropertySelectionReflector;
import com.eas.form.grid.FindWindow;
import com.eas.form.grid.Grid;
import com.eas.form.grid.GridSection;
import com.eas.form.grid.GridSelectionEventManager;
import com.eas.form.grid.builders.RenderedTableCellBuilder;
import com.eas.form.grid.builders.ThemedHeaderOrFooterBuilder;
import com.eas.form.grid.columns.CheckServiceColumn;
...
import com.eas.form.grid.columns.header.HeaderAnalyzer;
import com.eas.form.grid.columns.header.HeaderNode;
import com.eas.form.grid.columns.header.HeaderSplitter;
import com.eas.form.grid.rows.JsArrayListDataProvider;
import com.eas.form.grid.rows.JsArrayTreeDataProvider;
import com.eas.form.grid.rows.JsDataContainer;
import com.eas.form.grid.selection.CheckBoxesEventTranslator;
import com.eas.form.grid.selection.HasSelectionLead;
import com.eas.form.grid.selection.MultiJavaScriptObjectSelectionModel;
...
import com.eas.form.published.HasOnRender;
			...
			if (isTreeConfigured()) {
				...
				treeDataProvider.addExpandedHandler(new ExpandedHandler<JavaScriptObject>() {
					...
					public void expanded(JavaScriptObject anElement) {
						...
						if (onExpand != null) {
							JavaScriptObject jsEvent = Publisher.publishItemEvent(ModelGrid.this.published, anElement);
							try {
	...
	private native static void publish(ModelGrid aWidget, JavaScriptObject aPublished)/*-{
		aPublished.select = function(aRow) {
			if (aRow != null && aRow != undefined)
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::selectElement(Lcom/google/gwt/core/client/JavaScriptObject;)(aRow);
		};
		aPublished.unselect = function(aRow) {
			if (aRow != null && aRow != undefined)
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::unselectElement(Lcom/google/gwt/core/client/JavaScriptObject;)(aRow);
		};
		aPublished.clearSelection = function() {
			aWidget.@com.eas.form.published.widgets.model.ModelGrid::clearSelection()();
		};
		aPublished.find = function() {
			aWidget.@com.eas.form.published.widgets.model.ModelGrid::find()();
		};
		...
		aPublished.makeVisible = function(aRow, needToSelect) {
			...
			if (aRow != null)
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::makeVisible(Lcom/google/gwt/core/client/JavaScriptObject;Z)(aRow, need2Select);
			else
				return false;
		};
		aPublished.unsort = function() {
			aWidget.@com.eas.form.published.widgets.model.ModelGrid::unsort()();
		};
		
		aPublished.redraw = function() {
			aWidget.@com.eas.form.published.widgets.model.ModelGrid::redraw()();
		};
		aPublished.removeColumnNode = function(aColumnFacade){
			if(aColumnFacade && aColumnFacade.unwrap)
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::removeColumnNode(Lcom/eas/form/grid/columns/header/HeaderNode;)(aColumnFacade.unwrap());
			else
				return false;
		};
		aPublished.addColumnNode = function(aColumnFacade){
			if(aColumnFacade && aColumnFacade.unwrap)
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::addColumnNode(Lcom/eas/form/grid/columns/header/HeaderNode;)(aColumnFacade.unwrap());
		};
		aPublished.insertColumnNode = function(aIndex, aColumnFacade){
			if(aColumnFacade && aColumnFacade.unwrap)
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::insertColumnNode(ILcom/eas/form/grid/columns/header/HeaderNode;)(aIndex, aColumnFacade.unwrap());
		};
		aPublished.columnNodes = function(){
			var headerRoots = aWidget.@com.eas.form.published.widgets.model.ModelGrid::getHeader()();
			var rootsCount = headerRoots.@java.util.List::size()();
			var res = [];
			for(var r = 0; r < rootsCount; r++){
				var nNode = headerRoots.@java.util.List::get(I)(r);
				var jsNode = nNode.@com.eas.client.HasPublished::getPublished()();
				res.push(jsNode);
			}
			return res;
		};
		Object.defineProperty(aPublished, "headerVisible", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isHeaderVisible()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setHeaderVisible(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "draggableRows", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isDraggableRows()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setDraggableRows(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "frozenRows", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getFrozenRows()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setFrozenRows(I)(+aValue);
			}
		});
		Object.defineProperty(aPublished, "frozenColumns", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getFrozenColumns()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setFrozenColumns(I)(+aValue);
			}
		});
		Object.defineProperty(aPublished, "rowsHeight", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getRowsHeight()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setRowsHeight(I)(aValue * 1);
			}
		});
		Object.defineProperty(aPublished, "showHorizontalLines", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isShowHorizontalLines()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setShowHorizontalLines(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "showVerticalLines", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isShowVerticalLines()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setShowVerticalLines(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "showOddRowsInOtherColor", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isShowOddRowsInOtherColor()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setShowOddRowsInOtherColor(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "gridColor", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getGridColor()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setGridColor(Lcom/eas/form/published/PublishedColor;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "oddRowsColor", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getOddRowsColor()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setOddRowsColor(Lcom/eas/form/published/PublishedColor;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "cursorProperty", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getCursorProperty()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setCursorProperty(Ljava/lang/String;)(aValue ? '' + aValue : null);
			}
		});

		Object.defineProperty(aPublished, "onRender", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getOnRender()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setOnRender(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "onExpand", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getOnExpand()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setOnExpand(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "onCollapse", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getOnCollapse()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setOnCollapse(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "selected", {
			get : function() {
				var selectionList = aWidget.@com.eas.form.published.widgets.model.ModelGrid::getJsSelected()();
				var selectionArray = [];
		...
		Object.defineProperty(aPublished, "editable", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isEditable()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setEditable(Z)(aValue);
			}
		});
		Object.defineProperty(aPublished, "deletable", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isDeletable()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setDeletable(Z)(aValue);
			}
		});
		Object.defineProperty(aPublished, "insertable", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::isInsertable()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setInsertable(Z)(aValue);
			}
		});
		Object.defineProperty(aPublished, "data", {
			get : function() {
				return aWidget.@com.eas.form.published.HasBinding::getData()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasBinding::setData(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "field", {
			get : function() {
				return aWidget.@com.eas.form.published.HasBinding::getField()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.HasBinding::setField(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(aPublished, "parentField", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getParentField();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setParentField(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
		Object.defineProperty(aPublished, "childrenField", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.model.ModelGrid::getChildrenField();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.model.ModelGrid::setChildrenField(Ljava/lang/String;)(aValue != null ? '' + aValue : null);
			}
		});
	}-*/;

...
public class PlatypusSplitButton extends DropDownButton implements HasActionHandlers, HasJsFacade, HasEnabled, HasComponentPopupMenu, HasEventsExecutor, HasShowHandlers, HasHideHandlers, HasResizeHandlers {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		...
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setText(Ljava/lang/String;)(aValue!=null?''+aValue:null);
			}
		});
		Object.defineProperty(published, "icon", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getImageResource()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setImageResource(Lcom/google/gwt/resources/client/ImageResource;)(aValue);
			}
		});
		Object.defineProperty(published, "iconTextGap", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getIconTextGap()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setIconTextGap(I)(aValue);
			}
		});
		Object.defineProperty(published, "horizontalTextPosition", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getHorizontalTextPosition()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setHorizontalTextPosition(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalTextPosition", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getVerticalTextPosition()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setVerticalTextPosition(I)(+aValue);
			}
		});

		Object.defineProperty(published, "horizontalAlignment", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getHorizontalAlignment()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setHorizontalAlignment(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalAlignment", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getVerticalAlignment()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setVerticalAlignment(I)(+aValue);
			}
		});
		Object.defineProperty(published, "dropDownMenu", {
			get : function(){
				var menu = aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::getMenu()();
				return @com.eas.form.Publisher::checkPublishedComponent(Ljava/lang/Object;)(menu);
			},
			set : function(aValue){
				aWidget.@com.eas.form.published.widgets.PlatypusSplitButton::setMenu(Lcom/google/gwt/user/client/ui/MenuBar;)(aValue != null ? aValue.unwrap() : null);
			}
		});
	}-*/;
}

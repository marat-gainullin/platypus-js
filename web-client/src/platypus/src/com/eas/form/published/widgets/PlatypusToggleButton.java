...
public class PlatypusToggleButton extends ImageToggleButton implements RequiresResize, HasActionHandlers, HasJsFacade, HasPlatypusButtonGroup, HasComponentPopupMenu, HasEventsExecutor,
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		...
		Object.defineProperty(published, "text", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getText()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setText(Ljava/lang/String;)(aValue!=null?''+aValue:null);
			}
		});
		Object.defineProperty(published, "icon", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getImageResource()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setImageResource(Lcom/google/gwt/resources/client/ImageResource;)(aValue);
			}
		});
		Object.defineProperty(published, "iconTextGap", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getIconTextGap()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setIconTextGap(I)(aValue);
			}
		});
		Object.defineProperty(published, "horizontalTextPosition", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getHorizontalTextPosition()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setHorizontalTextPosition(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalTextPosition", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getVerticalTextPosition()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setVerticalTextPosition(I)(+aValue);
			}
		});

		Object.defineProperty(published, "horizontalAlignment", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getHorizontalAlignment()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setHorizontalAlignment(I)(+aValue);
			}
		});
		Object.defineProperty(published, "verticalAlignment", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getVerticalAlignment()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setVerticalAlignment(I)(+aValue);
			}
		});
		Object.defineProperty(published, "selected", {
			get : function() {
				return aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::getPlainValue()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.widgets.PlatypusToggleButton::setPlainValue(Z)(aValue!=null?aValue:false);
			}
		});

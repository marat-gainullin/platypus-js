			...
			public void onSelection(SelectionEvent<UIObject> event) {
				if (onItemSelected != null) {
					try {
						...
						Utils.executeScriptEventVoid(published, onItemSelected, Publisher.publishItemEvent(published, jsItem));
					} catch (Exception e) {
	...
	private native static void publish(HasPublished aWidget, JavaScriptObject published)/*-{
		published.add = function(toAdd){
			if(toAdd && toAdd.unwrap) {
				...
				aWidget.@com.eas.form.published.containers.ButtonGroup::add(Lcom/eas/client/HasPublished;)(toAdd.unwrap());
			}
		}
		published.remove = function(toRemove) {
			if(toRemove && toRemove.unwrap) {
				aWidget.@com.eas.form.published.containers.ButtonGroup::remove(Lcom/eas/client/HasPublished;)(toRemove.unwrap());
			}
		}
		published.clear = function() {
			aWidget.@com.eas.form.published.containers.ButtonGroup::clear()();				
		}
		published.child = function(aIndex) {
			var comp = aWidget.@com.eas.form.published.containers.ButtonGroup::getChild(I)(aIndex);
		    return @com.eas.form.ControlsUtils::checkPublishedComponent(Ljava/lang/Object;)(comp);					
		};
		...
		Object.defineProperty(published, "count", {
			get : function() {
				return aWidget.@com.eas.form.published.containers.ButtonGroup::size()();
			}
		});
	    Object.defineProperty(published, "name", {
		    get : function() {
		    	return aWidget.@com.eas.form.published.HasJsName::getJsName()();
		    }
 	    });
		Object.defineProperty(published, "onItemSelected", {
			get : function() {
				return aWidget.@com.eas.form.published.containers.ButtonGroup::getItemSelected()();
			},
			set : function(aValue) {
				aWidget.@com.eas.form.published.containers.ButtonGroup::setItemSelected(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			},
			configurable : true
		});
	}-*/;

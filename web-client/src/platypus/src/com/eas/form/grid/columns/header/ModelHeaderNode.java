...
public class ModelHeaderNode extends HeaderNode<JavaScriptObject> implements HasJsName, HasPublished {
	...
	private static native void publish(ModelHeaderNode aColumn, JavaScriptObject aPublished)/*-{
		Object.defineProperty(aPublished, "editor", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getJsEditor()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setEditor(Lcom/eas/form/published/widgets/model/ModelDecoratorBox;)(aValue && aValue.unwrap ? aValue.unwrap() : null);
			}
		});
		Object.defineProperty(aPublished, "field", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getField()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setField(Ljava/lang/String;)(aValue != null ? ''+aValue : '');
			}
		});
		Object.defineProperty(aPublished, "visible", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::isVisible()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setVisible(Z)((false != aValue));
			}
		});
		Object.defineProperty(aPublished, "minWidth", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getMinWidth()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setMinWidth(D)(aValue != null ? aValue : 0);
			}
		});
		Object.defineProperty(aPublished, "maxWidth", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getMaxWidth()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setMaxWidth(D)(aValue != null ? aValue : 0);
			}
		});
		Object.defineProperty(aPublished, "preferredWidth", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getPreferredWidth()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setPreferredWidth(D)(aValue != null ? aValue : 0);
			}
		});
		Object.defineProperty(aPublished, "width", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getWidth()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setWidth(D)(aValue != null ? aValue : 0);
			}
		});
		Object.defineProperty(aPublished, "title", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getTitle()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setTitle(Ljava/lang/String;)(aValue != null ? ''+aValue : '');
			}
		});
		Object.defineProperty(aPublished, "resizable", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::isResizable()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setResizable(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "movable", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::isMoveable()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setMoveable(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "readonly", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::isReadonly()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setReadonly(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "sortable", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::isSortable()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setSortable(Z)(!!aValue);
			}
		});
		Object.defineProperty(aPublished, "sortField", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getSortField()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setSortField(Ljava/lang/String;)(aValue != null ? ''+aValue : '');
			}
		});
		Object.defineProperty(aPublished, "foreground", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getForeground()()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setForeground(Lcom/eas/form/published/PublishedColor;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "background", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getBackground()()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setBackground(Lcom/eas/form/published/PublishedColor;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "font", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getFont()()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setFont(Lcom/eas/form/published/PublishedFont;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "onRender", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getOnRender()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setOnRender(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		Object.defineProperty(aPublished, "onSelect", {
			get : function() {
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getOnSelect()();
			},
			set : function(aValue) {
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::setOnSelect(Lcom/google/gwt/core/client/JavaScriptObject;)(aValue);
			}
		});
		aPublished.sort = function() {
			aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::sort()();
		};
		aPublished.sortDesc = function() {
			aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::sortDesc()();
		};
		aPublished.unsort = function() {
			aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::unsort()();
		};
		aPublished.removeColumnNode = function(aColumnFacade){
			if(aColumnFacade && aColumnFacade.unwrap)
				return aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::removeColumnNode(Lcom/eas/form/grid/columns/header/HeaderNode;)(aColumnFacade.unwrap());
			else
				return false;
		};
		aPublished.addColumnNode = function(aColumnFacade){
			if(aColumnFacade && aColumnFacade.unwrap)
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::addColumnNode(Lcom/eas/form/grid/columns/header/HeaderNode;)(aColumnFacade.unwrap());
		};
		aPublished.insertColumnNode = function(aIndex, aColumnFacade){
			if(aColumnFacade && aColumnFacade.unwrap)
				aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::insertColumnNode(ILcom/eas/form/grid/columns/header/HeaderNode;)(aIndex, aColumnFacade.unwrap());
		};
		aPublished.columnNodes = function(){
			var nChildren = aColumn.@com.eas.form.grid.columns.header.ModelHeaderNode::getChildren()();

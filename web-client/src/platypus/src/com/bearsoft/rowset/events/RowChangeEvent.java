...
public class RowChangeEvent extends RowsetEvent {
	 ...
	 * 
	 * @param source
	 *            Rowset changes are made to. It's nessasary to hold information
	 *            about <code>Rowset</code> because of filtering.
	 * @param aFieldIndex
	 *            Index of changing field. Index is 1 based.
	 * @param aOldValue
	 *            Value that is to be changed
	 * @param aNewValue
	 *            Value the field's value is to be changed to.
	 * @param aKind
	 ...
	 * 
	 * @param oldRowCount
	 *            Rows count in the rowset before changing the field's value.
	 */
	 ...
	 * 
	 * @param aValue
	 *            Rows count in the rowset after changing the field's value.
	 */

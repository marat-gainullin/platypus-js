...
/**
 * This class is intended to be a default implementor of the
 * <code>RowsetListener</code> interface. There are much number of method that
 * may veto any rowset's operation. And there is a danger to implement that
 * interface by youself and veto some operation without knowing about it. This
 * default implementor garateers that it wouldn't happen.
 * 
 * @author mg
 */

...
/**
 * Rowset scroll event. Occurs before and after the rowset is scrolled from one position to another.
 * @author mg.
 * @see RowsetListener
 */
public class RowsetScrollEvent extends RowsetEvent{
     ...
     * @param aOldRowIndex Row index that was current row before rowset is scrolled.
     * @param aNewRowIndex Row index that will be current row after rowset will be scrolled.

...
public class Parameters extends Fields
{
    ...
    /**
     * Returns <code>Parameter</code> instance at the specified index. Index is 1 based.
     * @param index Index of <code>Parameter</code> instance you are interested in.
     * @return <code>Parameter</code> instance at the specified index. If wrong index specified, than
     * null is returned.
     */
    @Override
     ...
     * @param aParameterName Parameter name of <code>Parameter</code> instance you are interested in.
     * @return <code>Parameter</code> instance with the specified name. If absent name is specified, than null is returned.
     */
    @Override
    ...
    /**
     * Returns parameters count, contained in this parameters set.
     * Same as <code>Fields.getFieldsCount()</code>.

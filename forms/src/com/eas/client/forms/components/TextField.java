...
import com.eas.client.forms.components.rt.VTextField;
 ...
 * @author mg
 */
public class TextField extends VTextField implements HasOnValueChange, HasJsValue, HasPublished, HasComponentEvents, HasEmptyText, HasJsName, Widget {

...
public class FieldTest {
    ...
    public void testGetTypeName() {
        ...
        String result = instance.getTypeInfo().getSqlTypeName();
        assertEquals(expResult, result);

        instance.getTypeInfo().setSqlTypeName("VARCHAR23");
        assertEquals(instance.getTypeInfo().getSqlTypeName(), "VARCHAR23");
        assertEquals(instance.getTypeInfo().getSqlType(), java.sql.Types.VARCHAR);
    }

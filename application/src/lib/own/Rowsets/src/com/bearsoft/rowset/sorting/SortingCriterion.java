...
public class SortingCriterion {
     ...
     * @param aColIndex Column(Field) index in rowset's <code>Fields</code>
     * @param aAscending Setting, defining the comparing direction.
     */
     ...
     * @param colIndex Column(Field) index.
     * @see #SortingCriterion(int aColIndex, boolean aAscending)
     * @see #getColIndex()
     */
     ...
     * @param ascending Ascending setting for this criterion.
     * @see #SortingCriterion(int aColIndex, boolean aAscending)
     * @see #isAscending()
     */

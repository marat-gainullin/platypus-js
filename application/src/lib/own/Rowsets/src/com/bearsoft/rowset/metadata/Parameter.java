 ...
 * datamodules. It holds information about field as the
 * <code>Field</code> class and additional information about parameter mode,
 * value, default value and it's selection form. If
...
*/
    ...
    public void assignFrom(Field aSourceField) {
        ...
        if (aSourceField instanceof Parameter) {
            ...
            if (!equalsOrNulls(getDefaultValue(), param.getDefaultValue())) {
                setDefaultValue(RowsetUtils.cloneFieldValue(param.getDefaultValue()));
            }
            if (!equalsOrNulls(getValue(), param.getValue())) {
                setValue(RowsetUtils.cloneFieldValue(param.getValue()));
            }
    ...
    public void setValue(Object aValue) {
        ...
        if (!readonly) {
            if (aValue == null || RowsetUtils.isTypeCompatible2JavaClass(typeInfo.getSqlType(), aValue.getClass())) {
                value = aValue;
                modified = true;
     ...
     * with
     * <code>getValueAsString()</code> method.
     *

 ...
 * @author mg
 */
public class DynamicTilesMachineTest extends GraphicTest {
    ...
    protected class LeftAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                Logger.getLogger(DynamicTilesMachineTest.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    public DynamicTilesMachineTest() {
        super();
    }
    ...
    public void simpleRectangleTest() throws InterruptedException {
        ...
        fr.setTitle(DynamicTilesMachineTest.class.getSimpleName());
        ...
        cache.setBackground(pane.getBackground());

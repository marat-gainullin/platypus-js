 ...
 * @author mg
 */
public class ZoomInAction extends GeoPaneAction {

    public static final double DEFAULT_ZOOM_FACTOR_STEP = 2.0f;

    public ZoomInAction(JGeoPane aPane) {
        super(aPane);
        putValue(Action.NAME, " + ");
        putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_ADD, 0));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            pane.scaleView(DEFAULT_ZOOM_FACTOR_STEP, DEFAULT_ZOOM_FACTOR_STEP, false);

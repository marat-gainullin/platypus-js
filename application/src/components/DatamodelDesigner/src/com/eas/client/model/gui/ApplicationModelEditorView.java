...
/*
    public NamespaceHost getNamespaceHost() {
        return namespaceHost;
    }

    public void setNamespaceHost(NamespaceHost aNamespaceHost) {
        if (namespaceHost != null) {
            namespaceHost.removeElement(this);
        }
        namespaceHost = aNamespaceHost;
        if (namespaceHost != null) {
            namespaceHost.addElement(this);
        }
        fieldsView.setNamespaceHost(namespaceHost);
    }
    ...
    public void setScriptHost(ScriptHost aScriptHost) {
 ...
 */
    ...
    public void rerouteConnectors() {
        modelView.forceRerouteConnectors();
    }

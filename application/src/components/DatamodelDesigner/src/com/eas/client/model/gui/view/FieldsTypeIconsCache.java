...
public class FieldsTypeIconsCache {
    ...
    static{
        icons16.put(new Integer(java.sql.Types.ARRAY),  "datatypes/16x16/blob.png");
        icons16.put(new Integer(java.sql.Types.BIGINT),  "datatypes/16x16/number.png");
        icons16.put(new Integer(java.sql.Types.BINARY), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.BIT), "datatypes/16x16/flag.png" );
        icons16.put(new Integer(java.sql.Types.BLOB), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.BOOLEAN), "datatypes/16x16/flag.png" );
        icons16.put(new Integer(java.sql.Types.CHAR), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.CLOB), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.DATALINK), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.DATE), "datatypes/16x16/date.png" );
        icons16.put(new Integer(java.sql.Types.DECIMAL), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.DISTINCT), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.DOUBLE), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.FLOAT), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.INTEGER), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.JAVA_OBJECT), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.LONGNVARCHAR), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.LONGVARBINARY), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.LONGVARCHAR), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.NCHAR), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.NCLOB), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.NULL), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.NUMERIC), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.NVARCHAR), "datatypes/16x16/text.png" );
        icons16.put(new Integer(java.sql.Types.OTHER), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.REAL), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.REF), "datatypes/16x16/number.png"  );
        icons16.put(new Integer(java.sql.Types.ROWID), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.SMALLINT), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.SQLXML), "datatypes/16x16/xml.png" );
        icons16.put(new Integer(java.sql.Types.STRUCT), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.TIME), "datatypes/16x16/date.png" );
        icons16.put(new Integer(java.sql.Types.TIMESTAMP), "datatypes/16x16/date.png" );
        icons16.put(new Integer(java.sql.Types.TINYINT), "datatypes/16x16/number.png" );
        icons16.put(new Integer(java.sql.Types.VARBINARY), "datatypes/16x16/blob.png" );
        icons16.put(new Integer(java.sql.Types.VARCHAR), "datatypes/16x16/text.png" );

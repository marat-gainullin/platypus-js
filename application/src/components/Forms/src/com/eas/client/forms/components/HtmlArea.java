...
import com.eas.client.forms.components.rt.VHtmlArea;
 ...
 * @author mg
 */
public class HtmlArea extends VHtmlArea implements HasOnValueChange, HasJsValue, HasPublished, HasComponentEvents, HasEmptyText, HasJsName, Widget {

...
public class CreateServerModuleResponseTest
{
    ...
    public void testGetModuleID()
    {
        ...
        CreateServerModuleResponse instance = new CreateServerModuleResponse(IDGenerator.genID(), "Test module ID", funcs, false);
    ...
    public void testReadData() throws Exception
    {
        ...
        writer.flush();
        CreateServerModuleResponse instance = new CreateServerModuleResponse(IDGenerator.genID(), null, null,  false);

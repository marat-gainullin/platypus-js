 ...
 * @author pk
 */
public class DbMapBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor() {
        ...
        if (beanDescriptor == null) {
            Class<?> lBeanClass = DbMap.class;
            Class<?> lCustomizerClass = DbMapCustomizer.class;
    ...
    public java.awt.Image getIcon(int iconKind) {
        switch (iconKind) {
            case ICON_COLOR_16x16:
                return DesignIconCache.getImage("16x16/map.png");
            case ICON_COLOR_32x32:
                return DesignIconCache.getImage("32x32/map.png");

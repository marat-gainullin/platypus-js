...
public class DbComboPopup<T> extends JPopupMenu implements ComboPopup {
    ...
    private static class EmptyListModelClass<T> implements ListModel<T>, Serializable {
     ...
     */
    protected void uninstallComboBoxModelListeners(ComboBoxModel<T> model) {
...
//        comboBox.unregisterKeyboardAction( KeyStroke.getKeyStroke( KeyEvent.VK_ENTER, 0 ) );
    ...
    //
    public DbComboPopup(DbComboBox<T> aComboBox) {
        super();
    ...
    /**
     * Creates a
     * <code>PropertyChangeListener</code> which will be added to the combo box.
    ...
    /**
     * Creates an
     * <code>ItemListener</code> which will be added to the combo box. If this
     * method returns null then it will not be added to the combo box. <p>
    ...
    protected class PopupList extends JList<T> {

        public PopupList(ComboBoxModel<T> aModel) {
            super(aModel);
        }
    ...
    protected JList<T> createList() {
        return new PopupList(comboBox.getModel());
        /*
     ...
     */
    protected void installComboBoxModelListeners(ComboBoxModel<T> model) {
     ...
     * drag.
     *
     * <p> <strong>Warning:</strong> We recommend that you <em>not</em> create
     ...
     * <p> All the functionality of this class has been included in
     ...
     * included for backwards API compatibility. Do not call or override. <p>
     * The functionality has been migrated into
     * <code>ItemHandler</code>.
     *
     * @see #createItemListener
     */
     ...
     * box. <p> Subclasses which wish to listen to combo box property changes
     * should call the superclass methods to ensure that the combo popup
     * correctly handles property changes.
     *
     * @see #createPropertyChangeListener
     */
    ...
    private class Handler implements ItemListener, MouseListener,
        ...
        @Override
        public void propertyChange(PropertyChangeEvent e) {
            DbComboBox<T> comboBox = (DbComboBox<T>) e.getSource();
            String propertyName = e.getPropertyName();
            switch (propertyName) {
                case "model":
                    ComboBoxModel<T> oldModel = (ComboBoxModel<T>) e.getOldValue();

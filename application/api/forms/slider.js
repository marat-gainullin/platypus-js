...
define(['boxing', 'common-utils/color', 'common-utils/cursor', 'common-utils/font', './action-event', './cell-render-event', './component-event', './focus-event', './item-event', './key-event', './value-change-event', './popup-menu'], function(B, Color, Cursor, Font, ActionEvent, RenderEvent, ComponentEvent, FocusEvent, ItemEvent, KeyEvent, ValueChangeEvent, PopupMenu) {
    ...
    function Slider(min, max, value) {
        ...
        var delegate = arguments.length > maxArgs ?
              arguments[maxArgs] 
            : arguments.length === 3 ? new javaClass(B.boxAsJava(min), B.boxAsJava(max), B.boxAsJava(value))
            : arguments.length === 2 ? new javaClass(B.boxAsJava(min), B.boxAsJava(max))
            : arguments.length === 1 ? new javaClass(B.boxAsJava(min))
            : new javaClass();
        ...
        Object.defineProperty(this, "value", {
            ...
            set: function(aValue) {
                delegate.value = B.boxAsJava(aValue);
            }
        });
        ...
        Object.defineProperty(this, "maximum", {
            ...
            set: function(aValue) {
                delegate.maximum = B.boxAsJava(aValue);
            }
        });
        ...
        Object.defineProperty(this, "minimum", {
            ...
            set: function(aValue) {
                delegate.minimum = B.boxAsJava(aValue);
            }
        });
    ...
    space.putPublisher(className, function(aDelegate) {
        return new Slider(null, null, null, aDelegate);
    });
    return Slider;
});
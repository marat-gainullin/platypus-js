...
define(['boxing', 'common-utils/color', 'common-utils/cursor', 'common-utils/font', './action-event', './cell-render-event', './component-event', './focus-event', './item-event', './key-event', './value-change-event', './popup-menu'], function(B, Color, Cursor, Font, ActionEvent, RenderEvent, ComponentEvent, FocusEvent, ItemEvent, KeyEvent, ValueChangeEvent, PopupMenu) {
     ...
     */
    function ToggleButton(text, icon, selected, iconTextGap, actionPerformed) {
        var maxArgs = 5;
        var delegate = arguments.length > maxArgs ?
              arguments[maxArgs] 
            : arguments.length === 5 ? new javaClass(B.boxAsJava(text), B.boxAsJava(icon), B.boxAsJava(selected), B.boxAsJava(iconTextGap), B.boxAsJava(actionPerformed))
            : arguments.length === 4 ? new javaClass(B.boxAsJava(text), B.boxAsJava(icon), B.boxAsJava(selected), B.boxAsJava(iconTextGap))
            : arguments.length === 3 ? new javaClass(B.boxAsJava(text), B.boxAsJava(icon), B.boxAsJava(selected))
        ...
        Object.defineProperty(this, "onValueChange", {
            ...
            set: function(aValue) {
                delegate.onValueChange = B.boxAsJava(aValue);
            }
        });
        ...
        Object.defineProperty(this, "selected", {
            ...
            set: function(aValue) {
                delegate.selected = B.boxAsJava(aValue);
            }
        });
        ...
        Object.defineProperty(this, "buttonGroup", {
            ...
            set: function(aValue) {
                delegate.buttonGroup = B.boxAsJava(aValue);
            }
        });
    ...
    space.putPublisher(className, function(aDelegate) {
        return new ToggleButton(null, null, null, null, null, aDelegate);
    });
    return ToggleButton;
});
(function() {
    var javaClass = Java.type("com.eas.client.model.application.ApplicationEntity");
    javaClass.setPublisher(function(aDelegate) {
        return new P.ApplicationEntity(aDelegate);
    });
        ...
        Object.defineProperty(this, "enqueueUpdate", {
            get: function() {
                return function() {
                    ...
                    var value = delegate.enqueueUpdate.apply(delegate, args);
                    return P.boxAsJs(value);
                };
            }
        });
        ...
        Object.defineProperty(this, "executeUpdate", {
            get: function() {
                return function() {
                    ...
                    var value = delegate.executeUpdate.apply(delegate, args);
                    return P.boxAsJs(value);
                };
            }
        });

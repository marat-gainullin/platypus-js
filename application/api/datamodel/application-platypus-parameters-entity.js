(function() {
    ...
    P.ApplicationPlatypusParametersEntity = function () {
         ...
         * @memberOf ApplicationPlatypusParametersEntity
         */
        P.ApplicationPlatypusParametersEntity.prototype.remove = function(aCursorPosOrInstance) {
            var delegate = this.unwrap();
         ...
         * @memberOf ApplicationPlatypusParametersEntity
         */
        P.ApplicationPlatypusParametersEntity.prototype.execute = function(onSuccess, onFailure) {
            var delegate = this.unwrap();
         ...
         * @memberOf ApplicationPlatypusParametersEntity
         */
        P.ApplicationPlatypusParametersEntity.prototype.removeAll = function() {
            var delegate = this.unwrap();

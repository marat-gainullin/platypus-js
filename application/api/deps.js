...
load('classpath:datamodel/application-entity.js');
load('classpath:datamodel/application-model.js');
...
load('classpath:forms/abstract-chart.js');
load('classpath:forms/abstract-line-chart.js');
...
load('classpath:forms/scalar-model-component.js');
...
load('classpath:rowsets/change.js');

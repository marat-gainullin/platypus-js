...
@set URL_CONFIG=http://research.office.altsoft.biz/platypus/client/updates/NightlyBuildNewUi/update.xml
@set URL_UPDATE=http://research.office.altsoft.biz/platypus/client/updates/NightlyBuildNewUi/application.zip

...
@set URL_CONFIG=http://olympic.altsoft.biz/platypus/client/updates/update.xml
@set URL_UPDATE=http://olympic.altsoft.biz/platypus/client/updates/application.zip
